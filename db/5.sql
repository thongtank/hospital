...
--
-- Host: localhost
-- Generation Time: Nov 11, 2015 at 05:30 AM
...
(2, 'admin', '489329', '2015-11-10 23:20:30');
...
(1, 'กก11021จ', 'ค่ายสรรพสิทธิประสงค์', '383 หมู่ 2 ถ.สถิตย์นิมานกาล', 23, 326, 2961, 34190, '15.1939973', '104.8732654', '045-3211735', 'thongtank@hotmail.com', '2015-10-27 23:08:49'),
(2, 'กด00091ด', 'ตาลสุม', '99 ถนนสมเด็จ', 23, 331, 3043, 34170, '15.312301', '105.123001', '045-396003,045-396051', '', '2015-10-28 14:54:48'),
(3, 'กต0012น', 'เขื่องใน', '83 หมู่ 6 ถนนแจ้งสนิท', 23, 315, 2825, 34150, '15.38666', '104.556572', '045-203004 -5', '', '2015-10-28 14:56:16'),
(4, 'กบ09192น', 'นาจะหลวย', '128 หมู่ 11', 23, 319, 2886, 34280, '14.521451', '105.241062', '045-379097', 'thongtank@hotmail.com', '2015-10-28 14:59:45'),
...
(8, 'ร.พ.46690น', 'พระศรีมหาโพธิ์', '212 ถนนแจ้งสนิท', 23, 312, 2788, 34000, '15.2502375', '104.8389271', '045352500', '', '2015-11-03 14:45:20'),
(9, 'ร.พ.3999น', 'วารินชำราบ', '46 หมู่ 6 ถนนวาริน-ศรีสะเกต', 23, 326, 2970, 34190, '15.1937854', '104.8358842', '0455267260-3', '', '2015-11-03 14:49:58'),
(10, 'ร.พ.96880น', 'ม่วงสามสิบ', '378 ชยางกรู', 23, 325, 2947, 34140, '15.512037', '104.729431', '045489064', '', '2015-11-03 14:52:25'),
(11, 'ร.พ.7896น', 'พิบูลมังสาหาร', '20/6 เทศบาล2', 23, 330, 3024, 34110, '15.245923', '105.226006', '045204590', '', '2015-11-03 14:54:55'),
...
(51, 'user111', '123456', 'กรุณ', 'รูปหล่อ', 26, 'นาย', 'M', '1988-12-21', '0875435550,045261624', '', '439 ถ.สรรพสิทธิ์', 23, 312, 2788, 34000, '1', '', '2015-11-10 23:14:13', '1', '0000-00-00 00:00:00');
...
--
ALTER TABLE `medical`
  MODIFY `medical_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `medicine_order`
--
ALTER TABLE `medicine_order`
  MODIFY `medicine_order_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=103;
--
-- AUTO_INCREMENT for table `profile`
--
ALTER TABLE `profile`
  MODIFY `profile_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=52;
--
...
--
ALTER TABLE `rating`
  MODIFY `rating_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `special_medical`
--
ALTER TABLE `special_medical`
  MODIFY `special_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=57;
--
-- AUTO_INCREMENT for table `typeofmedical`
--
ALTER TABLE `typeofmedical`
  MODIFY `medical_type_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=35;