...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2015 at 04:58 PM
...
(2, 'admin', '489329', '2015-11-03 21:03:06');
...
(1, 'กก11021จ', 'ค่ายสรรพสิทธิประสงค์', '383 หมู่ 2 ถ.สถิตย์นิมานกาล', 1, 4, 31, 34190, '123', '456', '045-3211735', 'thongtank@hotmail.com', '2015-10-27 23:08:49'),
(2, 'กด00091ด', 'ตาลสุม', '99 ถนนสมเด็จ ', 23, 331, 3043, 34170, '', '', '045-396003,045-396051', '', '2015-10-28 14:54:48'),
(3, 'กต0012น', 'เขื่องใน', '83 หมู่ 6 ถนนแจ้งสนิท', 23, 315, 2825, 34150, '', '', '045-203004 -5', '', '2015-10-28 14:56:16'),
(4, 'กบ09192น', 'นาจะหลวย', '128 หมู่ 11', 23, 319, 2886, 34280, '', '', '045-379097', 'thongtank@hotmail.com', '2015-10-28 14:59:45'),
(5, 'กบ.23332น', 'โรงพยาบาลราชเวช อุบลราชธานี', '999 ชยางกรู', 23, 312, 2788, 34000, '', '', '045280040', '', '2015-11-03 14:16:11'),
(6, 'ร.พ.3980น', 'โรงพยาบาลสรรพสิทธิประสงค์', '122 ถนนสรรพสิทธิ์', 23, 312, 2788, 34000, '', '', '045254153', '', '2015-11-03 14:26:04'),
(7, 'ร.พ.5777น', 'โรงพยาบาล เขมราฐ', '319', 23, 316, 2843, 34170, '', '', '045 491182', '', '2015-11-03 14:40:49'),
(8, 'ร.พ.46690น', 'พระศรีมหาโพธิ์', '212 ถนนแจ้งสนิท', 23, 312, 2788, 34000, '', '', '045352500', '', '2015-11-03 14:45:20'),
(9, 'ร.พ.3999น', 'วารินชำราบ', '46 หมู่ 6 ถนนวาริน-ศรีสะเกต', 23, 326, 2970, 34190, '', '', '0455267260-3', '', '2015-11-03 14:49:58'),
(10, 'ร.พ.96880น', 'ม่วงสามสิบ', '378 ชยางกรู', 23, 325, 2947, 34140, '', '', '045489064', '', '2015-11-03 14:52:25'),
(11, 'ร.พ.7896น', 'พิบูลมังสาหาร', '20/6 เทศบาล2', 23, 330, 3024, 34110, '', '', '045204590', '', '2015-11-03 14:54:55'),
(12, 'ร.พ.8913น', 'โรงพยาบาล50พรรษา', '300 หมู่3 ถนนอุบลตระการ(บ้านปลาดุก)', 23, 312, 2799, 34000, '', '', '045319300', '', '2015-11-03 15:01:43');
...
CREATE TABLE `medical` (
  ...
  `medical_type_new` varchar(255) DEFAULT NULL COMMENT 'ข้อมูลประเภทการรักษากรณีผู้ป่วยกรอกเอง',
  ...
  `medicine_order_id` varchar(10) DEFAULT NULL COMMENT 'รหัสการจ่ายยา'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(7, 'ramita', '123456', 'รมิตา', 'จิระกิจอนันต์', 25, 'นางสาว', 'F', '1990-10-10', '0877797910', 'p_ramij@hotmail.com', '439 ถ.สรรพสิทธิ์', 23, 312, 2788, 34000, '', '', '2015-11-01 17:14:30', '1', '0000-00-00 00:00:00'),
(8, 'surachet', '789076', 'Surachet', 'Kobsawat', 27, 'นาย', 'M', '1988-06-07', '0988884443', 'surachet@gmail.com', '5 หมู่ 1', 23, 312, 2788, 34000, '', '', '2015-11-01 17:18:47', '1', '0000-00-00 00:00:00'),
(9, 'tong', '1234', 'ต้อง', 'กรุณ', 26, 'นาย', 'M', '1988-12-21', '0875435550', 'karoon@outlook.com', '122 ถนนสรรพสิทธิ์', 5, 76, 445, 60000, '101.012312312312313', '291.012312312312313', '2015-11-01 17:41:26', '0', '2015-11-03 20:35:16'),
(18, 'worstz', '123456', 'Tester', 'Tester', 27, 'นาย', 'M', '1988-10-08', '0987676665', 'karoon@gmail.com', '66/5', 4, 70, 389, 60000, '101.99999', '999.10988', '2015-11-01 17:51:02', '1', '0000-00-00 00:00:00');
...
--
ALTER TABLE `medicine_order`
  MODIFY `medicine_order_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `profile`
--
ALTER TABLE `profile`
  MODIFY `profile_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `special_medical`
  MODIFY `special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
