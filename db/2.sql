...
--
-- Host: localhost:8889
-- Generation Time: Oct 28, 2015 at 01:44 PM
...
(2, 'admin', '489329', '2015-10-28 14:26:24');
...
(1, 'กข0991ว', 'ค่ายสรรพสิทธิประสงค์', '383 หมู่ 2 ถ.สถิตย์นิมานกาล', 23, 326, 2978, 34190, '', '', '045-321173-5', '', '2015-10-27 23:08:49'),
...
(4, 'กบ09192น', 'นาจะหลวย', '128 หมู่ 11', 23, 319, 2886, 34280, '', '', '045-379097', '', '2015-10-28 14:59:45');
...
CREATE TABLE `medicine` (
  ...
  `medicine_type` enum('ยาเม็ด','ยาน้ำ') NOT NULL COMMENT 'รูปแบบของยา',
  ...
  `medicine_status` enum('คงอยู่','ยกเลิก','','') NOT NULL DEFAULT '' COMMENT 'คงอยู่, ยกเลิก',
...
('1A 656/2531', 'พารา ไซรัป', 'PARA SYRUP', 'ยาน้ำ', 'ยาสามัญ', 'บรรเทาอาการปวดสำหรับเด็ก สมมติ', 'PARACETAMOL 120MG', 'คงอยู่', 'ภายใน', 'บริษัท บูรพาโอสถ  จำกัด', 'บริษัท บูรพาโอสถ  จำกัด', '19/19  ม.9   ซ.ทิมแลนด์  ถ.งามวงศ์วาน', 3, 58, 303, 11000, '0 2589 2750-3', '2015-10-28 19:43:50');
...
CREATE TABLE `profile` (
  ...
  `monthofbirth` varchar(30) NOT NULL DEFAULT '',
  ...
  `date_added` datetime NOT NULL,
  `privacy` enum('0','1') DEFAULT NULL COMMENT 'public user or not',
...
(2, 'ผ่าตัด', '2015-10-28 14:26:33', 'admin'),
(3, 'อายุรกรรม', '2015-10-28 14:28:11', 'admin'),
(4, 'เวชกรรม', '2015-10-28 15:23:44', 'admin');
...
--
ALTER TABLE `typeOfMedical`
  MODIFY `medical_type_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;