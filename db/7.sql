...
--
-- Host: localhost
-- Generation Time: Nov 18, 2015 at 05:04 AM
...
(2, 'admin', '489329', '2015-11-17 10:24:49');
...
CREATE TABLE `hospital` (
  ...
  `hospital_verify_code` varchar(100) NOT NULL,
  `hospital_name` varchar(255) NOT NULL DEFAULT '' COMMENT 'ชื่อ รพ.',
  `hospital_address` text NOT NULL COMMENT 'ที่อยู่ รพ.',
  `province` int(3) NOT NULL COMMENT 'จังหวัดที่ตั้ง',
  `amphur` int(3) NOT NULL COMMENT 'อำเภอที่ตั้ง',
  `district` int(3) NOT NULL COMMENT 'ตำบลที่ตั้ง',
  `zipcode` int(5) NOT NULL COMMENT 'รหัสไปรษณีย์',
  `lat` varchar(100) DEFAULT NULL COMMENT 'lattitude',
  `lng` varchar(100) DEFAULT NULL COMMENT 'longtitude',
  `tel` text NOT NULL COMMENT 'เบอร์ รพ. โทรศัพท์บ้าน คั่นด้วยเครื่องหมาย ","',
  `email` varchar(100) DEFAULT '' COMMENT 'เมล์',
...
INSERT INTO `hospital` (`hospital_id`, `hospital_verify_code`, `hospital_name`, `hospital_address`, `province`, `amphur`, `district`, `zipcode`, `lat`, `lng`, `tel`, `email`, `date_added`) VALUES
(1, 'กก11021จ', 'โรงพยาบาลค่ายสรรพสิทธิประสงค์', '383 หมู่ 2 ถ.สถิตย์นิมานกาล', 23, 326, 2961, 34190, '15.1939973', '104.8732654', '045-3211735', 'thongtank@hotmail.com', '2015-10-27 23:08:49'),
(2, 'กด00091ด', 'โรงพยาบาลตาลสุม', '99 ถนนสมเด็จ', 23, 331, 3043, 34170, '15.312301', '105.123001', '045-396003,045-396051', '', '2015-10-28 14:54:48'),
(3, 'กต0012น', 'โรงพยาบาลเขื่องใน', '83 หมู่ 6 ถนนแจ้งสนิท', 23, 315, 2825, 34150, '15.38666', '104.556572', '045-203004 -5', '', '2015-10-28 14:56:16'),
(4, 'กบ09192น', 'โรงพยาบาลนาจะหลวย', '128 หมู่ 11', 23, 319, 2886, 34280, '14.521451', '105.241062', '045-379097', 'thongtank@hotmail.com', '2015-10-28 14:59:45'),
(5, 'กบ.23332น', 'โรงพยาบาลราชเวช อุบลราชธานี', '999 ชยางกรู', 23, 312, 2788, 34000, '15.2672024', '104.8415648', '045280040', '', '2015-11-03 14:16:11'),
(6, 'ร.พ.3980น', 'โรงพยาบาลสรรพสิทธิประสงค์', '122 ถนนสรรพสิทธิ์', 23, 312, 2788, 34000, '15.236071', '104.863311', '045254153', '', '2015-11-03 14:26:04'),
(7, 'ร.พ.5777น', 'โรงพยาบาลเขมราฐ', '319', 23, 316, 2843, 34170, '16.039026', '105.210266', '045 491182', '', '2015-11-03 14:40:49'),
(8, 'ร.พ.46690น', 'โรงพยาบาลพระศรีมหาโพธิ์', '212 ถนนแจ้งสนิท', 23, 312, 2788, 34000, '15.2502375', '104.8389271', '045352500', '', '2015-11-03 14:45:20'),
(9, 'ร.พ.3999น', 'โรงพยาบาลวารินชำราบ', '46 หมู่ 6 ถนนวาริน-ศรีสะเกต', 23, 326, 2970, 34190, '15.1937854', '104.8358842', '0455267260-3', '', '2015-11-03 14:49:58'),
(10, 'ร.พ.96880น', 'โรงพยาบาลม่วงสามสิบ', '378 ชยางกรู', 23, 325, 2947, 34140, '15.512037', '104.729431', '045489064', '', '2015-11-03 14:52:25'),
(11, 'ร.พ.7896น', 'โรงพยาบาลพิบูลมังสาหาร', '20/6 เทศบาล2', 23, 330, 3024, 34110, '15.245923', '105.226006', '045204590', '', '2015-11-03 14:54:55'),
(12, 'ร.พ.8913น', 'โรงพยาบาล50พรรษา', '300 หมู่3 ถนนอุบลตระการ(บ้านปลาดุก)', 23, 312, 2799, 34000, '15.2993709', '104.902671', '045319300', '', '2015-11-03 15:01:43'),
(13, 'ฟน221', 'โรงพยาบาลยโสธร', '569 ม.1', 24, 346, 3112, 34221, '15.7814767', '104.1593602', '0985463215', 'yasoo@hotmail.com', '2015-11-11 14:44:38'),
(14, 'ร.พ 2987น', 'โรงพยาบาลลำพูน', '29/7', 39, 595, 5350, 35000, '', '', '08992647474', 'lompon_112@gmail.com', '2015-11-11 14:45:47'),
(15, 'ร.พ034852น', 'ค่ายสรรพสิทธิ์', 'หมู่ 2 383', 23, 326, 2978, 34190, '15.1939973', '104.8754594', '045 324 400', '', '2015-11-15 14:53:18'),
(16, 'อจ.001', 'โรงพยาบาลอำนาจเจริญ', '291 หมู่ 8 ถนนอรุณประเสริฐ', 26, 380, 3352, 37000, '15.8630748', '104.6239322', '045-511-940', '', '2015-11-15 15:49:31'),
(17, 'ศ.ก.001', 'โรงพยาบาล กันทรลักษ์', 'ม.5', 22, 293, 2596, 33110, '14.636638', '104.650178', '0-4563-5759-62', '', '2015-11-15 15:49:50'),
(18, 'อจ.002', 'โรงพยาบาลเสนางคนิคม', '83 ม.3', 26, 384, 3401, 37000, '16.0443677', '104.6690497', '045 461 008', '', '2015-11-15 15:52:59'),
(19, 'ศ.ก.002', 'โรงพยาบาลขุขันธ์', '109 หมู่ 6', 22, 294, 2645, 33140, '14.666411', '104.217962', '0-4581-4290-4', '', '2015-11-15 15:53:04'),
(20, 'ยส.001', 'โรงพยาบาลกุดชุม', '6 หมู่ 14 ถนนกุดชุม-เลิงนกทา', 24, 348, 3139, 35140, '16.0202492', '104.336176', '0-4578-9425-8', '', '2015-11-15 15:54:23'),
(21, 'ศ.ก.003', 'โรงพยาบาลกันทรารมย์', '183 หมู่ 12 ถนนประชารังสฤษด์', 22, 292, 2565, 33130, '15.103905', '104.573307', '0-4565-1144', '', '2015-11-15 15:55:35'),
(22, 'อจ.003', 'โรงพยาบาลหัวตะพาน', '176 หมู่ 7 ถนนประชาราษฎร์', 26, 385, 3414, 37240, '15.695732', '104.49249', '045469123', '', '2015-11-15 15:55:38'),
(23, 'ยส.002', 'โรงพยาบาลคำเขื่อนแก้ว', '784 หมู่ 2 ถนนลุมพุก-มห', 24, 349, 3148, 35110, '15.6542085', '104.3034881', '0-4579-1133', '', '2015-11-15 15:59:00'),
(24, 'ศ.ก.004', 'โรงพยาบาลขุนหาญ', '6 ถนนขุนหาญ-ศรีสะเกษ', 22, 297, 2665, 33150, '14.6214941', '104.423126', '0-4567-9026', '', '2015-11-15 16:00:40'),
(25, 'ยส.003', 'โรงพยาบาลค้อวัง', '2 หมู่ 11 ถนนค้อวัง-พลไว', 24, 352, 3183, 35160, '15.3659267', '104.3590987', '0-4579-7257', '', '2015-11-15 16:01:25'),
(26, 'อจ.004', 'โรงพยาบาลปทุมราชวงศา', '120 หมู่ 8', 26, 382, 3389, 37110, '15.899727', '104.935696', '045 465 209', '', '2015-11-15 16:01:54'),
(27, 'ยส.004', 'โรงพยาบาลทรายมูล', '100 หมู่ 14', 24, 347, 3134, 35170, '15.948576', '104.1964633', '0-4578-7023', '', '2015-11-15 16:05:33'),
(28, 'อจ.005', 'โรงพยาบาลชานุมาน', '4 หมู่ 8', 26, 381, 3381, 37210, '16.2357724', '104.9999667', '045 486 044', '', '2015-11-15 16:05:41'),
(29, 'ยส.005', 'โรงพยาบาลนายแพทย์หาญ', '160 - 164 ถนนวิทยะธำรงค์', 24, 346, 3112, 35000, '15.7922116', '104.1429311', '045 711 356', '', '2015-11-15 16:07:39'),
(30, 'อจ.006', 'โรงพยาบาลพนา', '255 หมู่ 1 ถนนอุปชิต', 26, 383, 3397, 37180, '15.6712186', '104.862393', '045 463 421', '', '2015-11-15 16:08:01'),
(31, 'ศ.ก.005', 'โรงพยาบาลน้ำเกลี้ยง', 'ม.5', 22, 304, 2745, 33130, '14.928542', '104.510986', '0-4560-9055-6', '', '2015-11-15 16:08:51'),
(32, 'ยส.005', 'โรงพยาบาลป่าติ้ว', '294 หมู่ 4 ถนนอรุณประเสริฐ', 24, 350, 3161, 35150, '15.8318727', '104.3827134', '045 795 015', '', '2015-11-15 16:09:40'),
(33, 'อจ.007', 'โรงพยาบาลลืออำนาจ', '101 หมู่ 6 ถนนชยางกูร', 26, 386, 3415, 37000, '15.6995774', '104.6426754', '045272325-6', '', '2015-11-15 16:10:14'),
(34, 'ศ.ก.006', 'โรงพยาบาลโนนคูณ', 'หมู่ 12', 22, 291, 2561, 33190, '14.924757', '104.686449', '0-4565-9044', '', '2015-11-15 16:12:07'),
(35, 'ยส.006', 'โรงพยาบาลมหาชนะชัย', '164 ม.4 ถ.มหา-ราศี', 24, 351, 3166, 35130, '', '', '045-799423', '', '2015-11-15 16:12:43'),
(36, 'ยส.007', 'โรงพยาบาลสมเด็จพระยุพราช เลิงนกทา', '284 หมู่ 1 ถนนทยาปัสสา', 24, 353, 3186, 35120, '16.196426', '104.5126083', '0-4578-1020', '', '2015-11-15 16:29:54'),
(37, 'อจ.008', 'โรงพยาบาลสต.น้ำปลีก', '307 หมู่9', 26, 380, 3360, 37000, '15.8631605', '104.6254838', '045-451055', '', '2015-11-15 16:30:34'),
(38, 'ศ.ก.007', 'โรงพยาบาลบึงบูรพ์', 'บึงบูรพ์', 22, 300, 2726, 33220, '15.3363561', '103.9759385', '045 689 043', '', '2015-11-15 16:35:37'),
(39, 'ศ.ก.008', 'โรงพยาบาลเบญจลักษ์ เฉลิมพระเกียรติ 80 พรรษา', 'เสียว', 22, 308, 2769, 33140, '14.7984003', '104.6678578', '045 605 392', '', '2015-11-15 16:40:28'),
(40, 'บร.001', 'โรงพยาบาลโนนดินแดง', '125 หมู่ 7', 20, 269, 2320, 31260, '14.308054', '102.734563', '0-4460-6384', '', '2015-11-15 16:48:11'),
(41, 'มห.001', 'โรงพยาบาลมุกดาหาร', '87 ถนน มุกดาหาร-ดอนตาล', 37, 561, 5052, 49000, '16.5417153', '104.7270218', '042 611 285', '', '2015-11-15 16:49:15'),
(42, 'บ.ร.002', 'โรงพยาบาลประโคนชัย', '190/15 ถนนโชคชัย-เดชอุดม', 20, 256, 2195, 31140, '14.6116014', '103.080209', '0-4465-1408', '', '2015-11-15 16:51:02'),
(43, 'มห.002', 'โรงพยาบาลคำชะอี', ': 55 ม.2 ถ.มุก-กุฉินารายณ์', 37, 565, 5104, 49110, '16.5587565', '104.4112446', '042 691 085', '', '2015-11-15 16:52:13'),
(44, 'สร.001', 'โรงพยาบาลสุรินทร์', '68', 21, 273, 2336, 32000, '14.889605', '103.3931258', '044 511 757', '', '2015-11-15 16:52:56'),
(45, 'บ.ร.003', 'โรงพยาบาลหนองกี่', '255 ถนนโชคชัย-เดชอุดม', 20, 254, 2178, 31210, '14.68652', '102.5351935', '0-4465-3316', '', '2015-11-15 16:53:40'),
(46, 'มห.005', 'โรงพยาบาลนิคมคำสร้อย', '52 หมู่ 11 ถนนนิคมคำสร้อย-หนองสูง', 37, 562, 5071, 49130, '', '', '042 638 358', '', '2015-11-15 16:55:28'),
(47, 'บ.ร.004', 'โรงพยาบาลนางรอง', '692 ถนนโชคชัย-เดชอุดม', 20, 253, 2140, 31110, '14.634634', '102.7875388', '0-4463-1368', '', '2015-11-15 16:55:49'),
(48, 'มห.004', 'โรงพยาบาลหนองสูง', '59 หมู่ 8 ถนนมุกดาหาร-กุฉินารายณ์', 37, 567, 5113, 49160, '', '', '042 635 117', '', '2015-11-15 16:57:59'),
(49, 'บ.ร.005', 'โรงพยาบาลกระสัง', '23 หมู่ 19 ถนนบุรีรัมย์-ประโคนชัย', 20, 252, 2129, 31160, '14.921751', '103.300663', '0-4469-1033', '', '2015-11-15 16:58:02'),
(50, 'สร.002', 'โรงพยาบาลกาบเชิง', '700 ถ.สุรินทร์-ช่องจอม ม.17', 21, 278, 2413, 32210, '14.8905921', '103.3931228', '044 559 002', '', '2015-11-15 16:58:30'),
(51, 'สร.003', 'โรงพยาบาลสังขะ', '700 ถนนสาธร', 21, 282, 2467, 32150, '14.8915792', '103.3931198', '044 572 019', '', '2015-11-15 17:01:26'),
(52, 'มห.006', 'โรงพยาบาลดงหลวง', '93 ม.3', 37, 564, 5085, 49140, '', '', '042 697 023', '', '2015-11-15 17:02:16'),
(53, 'มห.003', 'โรงพยาบาลหว้านใหญ่', '45 ม.9 ถ.เฉลิมพระเกียรติ ร.9', 37, 566, 5108, 49150, '', '', '042 699 085', '', '2015-11-15 17:06:21'),
(54, 'สร.004', 'โรงพยาบาลค่ายวีรวัฒน์โยธิน', '777/15 ถ.สุรินทร์-ปราสาท', 21, 273, 2336, 32000, '14.8935958', '103.3964382', '044-513603', '', '2015-11-16 15:30:23'),
(55, 'สร.005', 'โรงพยาบาลรัตนบุรี', '150 หมู่ 8 ถนนรัตนบุรี-ศีขรภูมิ', 21, 279, 2423, 32130, '14.8944126', '103.1161218', '044 536 203', '', '2015-11-16 15:32:18'),
(56, 'มห.007', 'โรงพยาบาลดอนตาล', '52 ม.11', 37, 563, 5078, 49130, '16.310278', '104.924679', '042 689 085', '', '2015-11-16 15:33:22'),
(57, 'บ.ร.006', 'โรงพยาบาลค่ายสมเด็จเจ้าพระยา มหากษัตริย์ศึก', 'หมู่ 9 ถนนบุรีรัมย์-ประโคนชัย', 20, 250, 2094, 31000, '14.9184122', '103.0799893', '044-613834-5', '', '2015-11-16 15:52:24'),
(58, 'บ.ร.007', 'โรงพยาบาลเอกชนบุรีรัมย์', '197 หมู่ 2 ถนนบุรีรัมย์-พุทไธสง', 20, 250, 2111, 31000, '15.0046091', '103.1120733', '044-614100', '', '2015-11-16 15:55:21'),
(59, 'บ.ร.008', 'โรงพยาบาลพลับพลาชัย', '99 หมู่ 1', 20, 264, 2295, 31250, '14.7285131', '103.1526389', '044 608 035', '', '2015-11-16 15:59:00');
...
CREATE TABLE `medical` (
  ...
  `organ` text COMMENT 'อาการป่วยที่เข้ารับการรักษา',
  `cost` int(11) NOT NULL COMMENT 'ค่ารักษาพยาบาล',
  ...
  `medical_type_id` int(11) DEFAULT NULL COMMENT 'ข้อมูลประเภทของการรักษาเลือกจากฐานข้อมูล',
...
INSERT INTO `medical` (`medical_id`, `organ`, `cost`, `date_start`, `date_end`, `rating`, `comment`, `hospital_id`, `profile_id`, `medical_type_id`, `date_added`) VALUES
(1, 'ไส้ติ่งอักเสบ', 20000, '2015-11-06', '2015-11-13', '5', NULL, 6, 'user1', 6, '2015-11-06 12:18:49'),
(2, 'คลอดลูก', 10000, '2015-11-06', '2015-11-06', '4', NULL, 10, 'user2', 7, '2015-11-06 12:22:45'),
(3, 'คลอด', 12000, '2015-11-06', '2015-11-13', '5', NULL, 10, 'user3', 7, '2015-11-06 15:25:02'),
(4, 'ซึมเศร้า', 8000, '2015-11-07', '2015-11-08', '4', 'พยาบาลดูแลเป็นอย่างดีและคุณหมอพูดจาสุภาพเป็นอย่างมาก', 8, 'user3', 22, '2015-11-07 12:53:10'),
(5, 'เป็นไข้หวัดใหญ่', 2500, '2015-11-03', '2015-11-04', '5', 'ดีมากค่ะ', 1, 'user10', 3, '2015-11-07 14:17:08'),
(6, 'แขนหัก', 12000, '2015-10-26', '2015-12-06', '5', 'เยี่ยม', 1, 'user21', 21, '2015-11-07 14:18:58'),
(7, 'ปวดฟัน', 30, '2015-09-01', '2015-09-01', '4', 'บริการดีมาก', 2, 'user10', 16, '2015-11-07 14:21:16'),
(8, 'กล้ามเนื้ออ่อนแรง', 10000, '2015-06-10', '2015-07-16', '4', 'รักษาดีมากค่ะ', 12, 'user31', 34, '2015-11-07 14:23:33'),
(9, 'ตรวจครรภ์', 500, '2015-11-04', '2015-11-04', '5', 'รักษาดีมากค่ะ', 11, 'user32', 7, '2015-11-07 14:26:50'),
(10, 'โรคเครียด', 300, '2015-11-02', '2015-11-02', '5', 'บริการดีมาก\r\n', 2, 'user11', 22, '2015-11-07 14:28:23'),
(11, 'ไข้', 200, '2015-11-02', '2015-11-02', '4', 'หมอน่ายั๊กกครับ', 3, 'user22', 17, '2015-11-07 14:28:28'),
(12, 'เครียดปวดหัว', 300, '2015-01-08', '2015-01-08', '5', 'บริการดีมากค่ะ', 10, 'user33', 22, '2015-11-07 14:30:17'),
(13, 'ไส้ติ่ง', 12000, '2015-10-21', '2015-10-28', '5', 'บริการดีมากค่ะ', 9, 'user34', 6, '2015-11-07 14:34:05'),
(14, 'ท้องอืด', 1000, '2015-05-12', '2015-05-12', '5', 'บริการดีมากค่ะ', 8, 'user35', 17, '2015-11-07 14:37:08'),
(15, 'ผ่าไส้ติ่ง', 2000, '2015-10-09', '2015-10-14', '5', 'บริการดีมาก', 6, 'user14', 6, '2015-11-07 14:37:54'),
(16, 'ฟันผุ', 300, '2015-06-10', '2015-06-10', '5', 'บริการดีมากค่ะ', 7, 'user36', 16, '2015-11-07 14:39:02'),
(17, 'ผังพืด', 5000, '2015-08-14', '2015-08-18', '5', 'บริการดีมากค่ะ', 6, 'user37', 6, '2015-11-07 14:40:42'),
(18, '', 3000, '2015-11-04', '2015-11-04', '5', 'บริการดีมากค่ะ', 5, 'user38', 20, '2015-11-07 14:42:02'),
(19, 'ชรา', 200, '2015-02-04', '2015-02-04', '5', 'บริการดีมากค่ะ', 4, 'user39', 3, '2015-11-07 14:43:36'),
(20, 'แผลที่หน้า', 10000, '2015-10-08', '2015-10-14', '5', 'บริการดีมากค่ะ', 3, 'user40', 18, '2015-11-07 14:45:26'),
(21, 'เป็นไข้เลือดออก', 200, '2015-09-12', '2015-09-12', '5', 'บริการมาก', 4, 'user13', 3, '2015-11-07 14:53:40'),
(22, 'เอ็กซ์เรย์', 100, '2015-11-02', '2015-11-02', '4', 'ดีมาก', 1, 'user28', 20, '2015-11-07 15:02:11'),
(23, 'ไข้', 200, '2015-11-18', '2015-11-18', '3', 'หายแล้วขอบคุนครับ', 10, 'user23', 17, '2015-11-07 15:04:01'),
(24, 'เสริมจมูก', 15000, '2015-10-06', '2015-10-08', '5', 'บริการดีมาก', 6, 'user14', 18, '2015-11-07 15:06:58'),
(25, 'เสริมจมูก', 1300, '2015-11-24', '2015-12-01', '4', 'จมูกสวยยย', 11, 'user24', 17, '2015-11-07 15:07:17'),
(26, 'อุดฟัน', 30, '2015-08-04', '2015-08-04', '5', 'บริการดีมาก', 3, 'user15', 16, '2015-11-07 15:08:37'),
(27, 'ฟื้นฟูร่างกาย', 45000, '2015-11-10', '2015-11-10', '4', 'ดีมากๆครับ', 6, 'user25', 22, '2015-11-07 15:09:05'),
(28, '', 5000, '2015-10-02', '2015-10-04', '5', 'บริการมาก\r\n', 5, 'user16', 22, '2015-11-07 15:10:46'),
(29, 'ปรึกษาเรื่องครอบครัว', 1500, '2015-11-04', '2015-11-04', '4', 'ขอบคุนครับ', 12, 'user26', 28, '2015-11-07 15:10:49'),
(30, 'คลอดลูก', 3000, '2015-09-17', '2015-09-20', '5', 'บริการดีมาก', 6, 'user17', 7, '2015-11-07 15:12:41'),
(31, 'ไส้ติ่งอักเสบ', 2500, '2015-11-09', '2015-11-15', '3', 'ดีครับ', 3, 'user27', 6, '2015-11-07 15:12:48'),
(32, 'นิ่วในถุงน้ำดี', 19500, '2015-11-11', '2015-11-28', '5', 'ดีมาก', 4, 'user29', 6, '2015-11-07 15:14:26'),
(33, '', 700, '2015-08-30', '2015-08-03', '5', 'บริการดีมาก', 8, 'user18', 22, '2015-11-07 15:14:35'),
(34, 'ปวดท้อง', 100, '2015-10-24', '2015-10-24', '5', 'ดีมาก', 4, 'user19', 3, '2015-11-07 15:16:51'),
(35, 'ประสาท', 100, '2015-11-17', '2015-11-19', '5', 'ดีครับ', 6, 'user30', 22, '2015-11-07 15:17:16'),
(36, 'กล้ามเนื้ออ่อนล่า', 3000, '2015-09-14', '2015-09-15', '5', 'บริการดีมาก', 3, 'user20', 34, '2015-11-07 15:19:42'),
(37, 'ตาแดง', 500, '2015-11-14', '2015-11-14', '5', 'บริการดีมากค่ะ', 6, 'user31', 17, '2015-11-07 15:30:51'),
(38, 'มะเร็ง', 2000, '2015-06-25', '2015-06-25', '5', 'บริการดีมากค่ะ', 12, 'user32', 25, '2015-11-07 15:34:10'),
(39, 'ท้องอืด', 200, '2015-10-24', '2015-10-24', '5', 'บริการดีมาก', 4, 'user12', 4, '2015-11-07 15:34:16'),
(40, 'ขูดหินปู', 500, '2015-05-05', '2015-05-05', '5', 'บริการดีมากค่ะ', 8, 'user33', 16, '2015-11-07 15:36:47'),
(41, 'ความดันต่ำ', 300, '2015-09-16', '2015-09-16', '5', 'บริการดีมากค่ะ', 5, 'user34', 3, '2015-11-07 15:38:25'),
(42, 'ท้องผุ', 100, '2015-10-21', '2015-10-21', '5', 'บริการดีมาก', 7, 'user14', 24, '2015-11-07 15:39:01'),
(43, 'ทำหมัน', 2000, '2015-09-22', '2015-09-22', '5', 'บริการดีมาก', 6, 'user15', 6, '2015-11-07 15:41:15'),
(44, 'ปากแหว่งเพดานโหว่', 10000, '2015-06-10', '2015-06-17', '5', 'บริการดีมากค่ะ', 5, 'user35', 18, '2015-11-07 15:41:42'),
(45, 'ท้องเสีย', 200, '2015-11-03', '2015-11-05', '4', 'ดีครับ', 1, 'user21', 17, '2015-11-07 15:42:15'),
(46, 'ปวดข้อกะดูก', 1000, '2015-10-06', '2015-10-08', '5', 'บริการดีมาก', 6, 'user15', 20, '2015-11-07 15:42:42'),
(47, 'ทำตาสองชั้น', 12000, '2015-05-21', '2015-05-28', '4', 'บริการดีมากค่ะ', 1, 'user36', 1, '2015-11-07 15:43:10'),
(48, '', 3000, '2015-08-18', '2015-08-18', '5', 'บริการดีมาก', 2, 'user16', 34, '2015-11-07 15:43:54'),
(49, 'หูแว่วเห็นภาพหลอน', 1000, '2015-07-08', '2015-07-08', '5', 'บริการดีมากค่ะ', 8, 'user37', 22, '2015-11-07 15:45:16'),
(50, 'ผ่าฟันคุด', 200, '2015-10-29', '2015-10-29', '5', 'บริการดีมาก', 3, 'user17', 16, '2015-11-07 15:45:50'),
(51, '', 1000, '2015-10-14', '2015-10-14', '5', 'บริการดีมาก', 6, 'user18', 19, '2015-11-07 15:47:28'),
(52, '', 2000, '2015-09-13', '2015-09-13', '5', 'บริการดีมาก', 6, 'user18', 20, '2015-11-07 15:49:04'),
(53, 'นอนไม่หลับ', 200, '2015-11-03', '2015-11-03', '5', 'ดีมาก', 3, 'user22', 17, '2015-11-07 16:08:41'),
(54, 'คลอด,ครรภ์', 30000, '2015-11-10', '0000-00-00', '5', '', 1, 'user1', 7, '2015-11-10 13:43:07'),
(55, 'แขนหัก', 1500, '2015-11-10', '0000-00-00', '5', '', 10, 'user1', 9999, '2015-11-10 22:59:09'),
(56, 'ทำจมูก', 15000, '2015-11-11', '0000-00-00', '5', 'ทำได้สวยมากครับ', 1, 'user111', 1, '2015-11-11 12:44:53'),
(57, 'ปวดฟัน', 1000, '2015-11-12', '2015-11-12', '5', '', 3, 'fah', 16, '2015-11-11 15:06:05'),
(58, 'จมูก', 15000, '2015-11-11', '2015-11-12', '3', 'เบี้ยวเล็กน้อย', 1, 'fahnutty', 1, '2015-11-11 15:06:51'),
(59, 'จัดฟัน', 30000, '2015-11-11', '0000-00-00', '5', 'บวม', 6, 'fahnutty', 16, '2015-11-11 15:07:58'),
(60, 'ตรวจครรภ์', 500, '2015-11-09', '0000-00-00', '3', 'ดีมาก', 5, 'fah', 7, '2015-11-11 15:08:06'),
(61, 'ครรภ์', 30000, '0000-00-00', '0000-00-00', '5', '', 2, 'fah', 3, '2015-11-11 15:12:46'),
(62, 'ไข้เลือดออก', 500, '2015-11-11', '0000-00-00', '3', '', 4, 'fahnutty', 19, '2015-11-11 15:13:39'),
(63, 'คลอดลูก,ตรวจครรภ์', 20000, '2015-11-02', '2015-11-08', '4', '', 6, 'user10', 7, '2015-11-11 15:19:04'),
(64, 'คลอดลูก,ตรวจครรภ์', 15000, '2015-11-23', '2015-11-23', '3', '', 6, 'user21', 1, '2015-11-11 15:19:06'),
(65, 'คลอด,ครรภ์', 15000, '2015-11-05', '2015-11-09', '4', '', 6, 'user11', 7, '2015-11-11 15:20:42'),
(66, 'คลอดบุตร,ตรวจครรภ์', 10000, '2015-11-09', '2015-11-09', '3', '', 6, 'user22', 7, '2015-11-11 15:20:43'),
(67, 'คลอดบุตร,ตรวจครรภ์', 12000, '2015-11-03', '2015-11-03', '4', '', 6, 'user23', 7, '2015-11-11 15:21:54'),
(68, 'ครรภ์,คลอด', 20000, '2015-11-03', '2015-11-07', '5', '', 4, 'user12', 7, '2015-11-11 15:22:49'),
(69, 'คลอดบุตร,ตรวจครรภ์', 1000, '2015-11-05', '2015-11-05', '4', '', 6, 'user24', 7, '2015-11-11 15:23:30'),
(70, 'ครรภ์,คลอด', 10000, '2015-11-03', '2015-11-08', '5', '', 4, 'user13', 7, '2015-11-11 15:24:28'),
(71, 'คลอดบุตร,ตรวจครรภ์', 200, '2015-11-03', '2015-11-04', '4', '', 6, 'user25', 7, '2015-11-11 15:28:02'),
(72, 'ครรภ์,คลอด', 20000, '2015-10-26', '2015-10-30', '4', '', 6, 'user14', 7, '2015-11-11 15:28:25'),
(73, 'ครรภ์,คลอด', 25000, '2015-11-03', '2015-11-07', '4', '', 6, 'user15', 7, '2015-11-11 15:29:58'),
(74, 'คลอดบุตร,ตรวจครรภ์', 250, '2015-11-05', '0000-00-00', '4', '', 12, 'user26', 7, '2015-11-11 15:30:39'),
(75, 'ครรภ์,คลอด', 30000, '2015-10-26', '2015-10-29', '4', '', 5, 'user16', 7, '2015-11-11 15:31:05'),
(76, 'คลอดบุตร,ตรวจครรภ์', 2800, '2015-11-13', '2015-12-05', '3', '', 3, 'user27', 7, '2015-11-11 15:31:43'),
(77, 'ครรภ์,คลอด', 15000, '2015-10-28', '2015-10-31', '5', '', 6, 'user18', 7, '2015-11-11 15:32:24'),
(78, 'คลอดบุตร,ตรวจครรภ์', 2500, '2015-11-06', '2015-11-13', '3', '', 6, 'user28', 7, '2015-11-11 15:32:37'),
(79, 'คลอด,ครรภ์', 20000, '2015-10-31', '2015-11-03', '4', '', 4, 'user19', 7, '2015-11-11 15:33:20'),
(80, 'คลอดบุตร,ตรวจครรภ์', 5000, '2015-11-07', '2015-11-28', '3', '', 4, 'user29', 7, '2015-11-11 15:33:22'),
(81, 'ครรภ์,คลอด', 25000, '2015-11-02', '2015-11-05', '3', '', 3, 'user20', 7, '2015-11-11 15:34:00'),
(82, 'คลอดบุตร,ตรวจครรภ์', 2500, '2015-11-12', '2015-11-20', '3', '', 6, 'user30', 7, '2015-11-11 15:34:19'),
(83, 'คลอดบุตร,ตรวจครรภ์', 25000, '2015-11-19', '2015-11-26', '3', '', 1, 'user40', 7, '2015-11-11 15:35:15'),
(84, 'คลอด,ครรภ์', 15000, '2015-10-29', '2015-11-03', '5', '', 5, 'user31', 7, '2015-11-11 15:35:26'),
(85, 'คลอดบุตร,ตรวจครรภ์', 50000, '2015-11-15', '2015-11-25', '3', '', 5, 'user39', 7, '2015-11-11 15:36:09'),
(86, 'คลอด,ครรภ์', 25000, '2015-10-26', '2015-10-29', '5', '', 12, 'user33', 7, '2015-11-11 15:36:42'),
(87, 'คลอดบุตร,ตรวจครรภ์', 10000, '2015-11-15', '2015-11-20', '3', '', 9, 'user38', 7, '2015-11-11 15:37:16'),
(88, 'ครรภ์,คลอด', 10000, '2015-10-26', '2015-10-29', '5', '', 5, 'user34', 7, '2015-11-11 15:38:28'),
(89, 'คลอดบุตร,ตรวจครรภ์', 12500, '2015-11-19', '2015-11-27', '3', '', 10, 'user37', 7, '2015-11-11 15:38:49'),
(90, 'ครรภ์,คลอด', 25000, '2015-11-02', '2015-11-05', '5', '', 5, 'user35', 7, '2015-11-11 15:40:24'),
(91, 'คลอดบุตร,ตรวจครรภ์', 10000, '2015-11-15', '2015-12-01', '4', '', 5, 'user36', 7, '2015-11-11 15:40:48'),
(92, 'ป่วยทางจิต', 10000, '2015-11-26', '2015-12-03', '3', '', 1, 'user10', 22, '2015-11-15 14:40:32'),
(93, 'เป็นไข้เลือดออก', 2000, '2015-11-05', '2015-11-10', '5', 'คนเยอะมาก', 23, 'user10', 4, '2015-11-16 16:21:03'),
(94, 'ท้องเสีย', 1500, '2015-10-26', '2015-10-29', '5', 'บริการดีมาก', 20, 'user10', 4, '2015-11-16 16:24:17'),
(95, 'ท้องอืด', 1200, '2015-11-02', '2015-11-02', '4', 'บริการดีมาก', 23, 'user10', 4, '2015-11-16 16:27:35'),
(96, 'ปวดฟัน', 1000, '2015-11-03', '2015-11-03', '5', 'บริการดีมาก', 25, 'user11', 4, '2015-11-16 16:30:25'),
(97, 'คลอดลูก', 2500, '2015-11-10', '2015-11-13', '5', 'บริการดีมาก', 46, 'user11', 7, '2015-11-16 16:34:25'),
(98, 'ต่อมทอมซินอักเสบ', 3000, '2015-01-06', '2015-01-13', '4', '', 44, 'user31', 4, '2015-11-16 16:40:12'),
(99, 'ไข้เลือดออก', 3000, '2015-11-03', '2015-11-05', '5', 'บริการดีมาก\r\n', 27, 'user13', 4, '2015-11-16 16:42:20'),
(100, 'x-ray สมอง', 1000, '2015-02-04', '2015-02-04', '5', '', 16, 'user32', 20, '2015-11-16 16:43:50'),
(101, 'ความดัน', 800, '2015-11-04', '2015-11-04', '5', 'ดีมาก', 41, 'user13', 3, '2015-11-16 16:44:09'),
(102, 'ทำปากกระจับ', 15000, '2015-03-05', '2015-03-05', '4', '', 18, 'user33', 18, '2015-11-16 16:46:13'),
(103, 'เบาหวาน', 500, '2015-11-02', '2015-11-02', '5', 'ดีมาก', 43, 'user14', 3, '2015-11-16 16:47:24'),
(104, 'ผังพืดที่เท้า', 3500, '2015-04-10', '2015-04-14', '5', '', 33, 'user34', 6, '2015-11-16 16:48:07'),
(105, 'ใส้ติ่ง', 2000, '2015-11-04', '2015-11-04', '5', 'ดีมาก', 43, 'user14', 6, '2015-11-16 16:48:37'),
(106, 'ถอนฟัน', 200, '2015-05-18', '2015-05-18', '5', '', 22, 'user35', 16, '2015-11-16 16:49:45'),
(107, 'ไข้หวัด คัดจมูก', 1200, '2015-11-03', '2015-11-05', '5', 'บริการดีมาก', 52, 'user15', 4, '2015-11-16 16:50:23'),
(108, 'แพ้แมลง', 1000, '2015-06-17', '2015-06-19', '5', '', 26, 'user36', 4, '2015-11-16 16:51:19'),
(109, 'ปวดตามร่างกาย', 450, '2015-11-09', '2015-11-09', '5', 'ดีมาก', 25, 'user15', 34, '2015-11-16 16:52:01'),
(110, 'ตาอักเสบ', 500, '2015-07-15', '2015-07-16', '5', '', 28, 'user37', 4, '2015-11-16 16:54:14'),
(111, 'ชีส ที่ปลีกมดลูก', 2000, '2015-11-04', '2015-11-08', '5', 'ดีมาก\r\n', 13, 'user16', 6, '2015-11-16 16:54:22'),
(112, 'ไข้หวัด', 500, '2015-11-03', '2015-11-03', '5', 'ดีมาก', 25, 'user16', 3, '2015-11-16 16:56:04'),
(113, 'ผ่าต้อกระจก', 5000, '2015-08-05', '2015-08-06', '4', '', 30, 'user38', 6, '2015-11-16 16:56:39'),
(114, 'ถอนฟันคุด', 2000, '2015-11-04', '2015-11-04', '5', 'ดีมาก', 48, 'user16', 16, '2015-11-16 16:57:56'),
(115, 'ปวดต้นคอ', 500, '2015-09-21', '2015-09-21', '5', '', 37, 'user39', 4, '2015-11-16 16:58:29'),
(116, 'ตากุ้งยิง', 1000, '2015-11-03', '2015-11-04', '5', 'ดีมาก', 52, 'user17', 4, '2015-11-16 17:00:40'),
(117, 'อัมพาต อัมพฤกษ์', 10000, '2015-11-10', '2015-11-14', '5', '', 50, 'user40', 34, '2015-11-16 17:01:33'),
(118, 'ไข้เลือดออก', 3500, '2015-11-17', '2015-11-20', '5', 'ดีมาก', 53, 'user17', 4, '2015-11-16 17:02:55'),
(119, 'ใส้ติ่ง', 4000, '2015-11-04', '2015-11-08', '5', 'ดีมาก', 27, 'user17', 6, '2015-11-16 17:04:16'),
(120, 'ความดัน', 1500, '2015-11-03', '2015-11-21', '5', '', 17, 'user21', 35, '2015-11-16 17:05:14'),
(121, 'ความดัน', 1220, '2015-11-02', '2015-11-03', '5', 'ดีมาก', 32, 'user17', 3, '2015-11-16 17:05:49'),
(122, 'ไข้เลือดออก', 2000, '2015-11-04', '2015-11-08', '5', 'ดีมาก', 36, 'user18', 4, '2015-11-16 17:07:25'),
(123, 'ท้องเสีย', 2000, '2015-11-04', '2015-11-05', '5', 'ดีมาก', 29, 'user18', 4, '2015-11-16 17:11:03'),
(124, 'หัวแตก,กระดูกหัก', 3000, '2015-12-01', '2015-12-08', '5', '', 59, 'user22', 36, '2015-11-16 17:11:47'),
(125, 'อุดฟัน', 200, '2015-11-04', '2015-11-04', '5', 'ดีมาก', 41, 'user18', 16, '2015-11-16 17:12:24'),
(126, 'ตรวจครรภ์', 500, '2015-11-02', '2015-11-02', '5', 'ดีมาก', 40, 'user19', 7, '2015-11-16 17:13:42'),
(127, 'ไขมันอุดตันในเลือด', 500, '2015-06-09', '2015-06-09', '5', '', 58, 'user23', 37, '2015-11-16 17:14:00'),
(128, 'ตาแดง', 850, '2015-11-03', '2015-11-03', '5', 'ดีมาก', 20, 'user19', 4, '2015-11-16 17:14:46'),
(129, 'อุดฟัน', 500, '2015-11-04', '2015-11-04', '5', '', 57, 'user24', 16, '2015-11-16 17:14:57'),
(130, 'ใส้ติ่ง', 4000, '2015-10-26', '2015-10-30', '5', 'ดีมาก', 35, 'user19', 6, '2015-11-16 17:15:45'),
(131, 'โรคภูมิแพ้', 200, '2015-10-07', '2015-10-07', '5', '', 55, 'user25', 37, '2015-11-16 17:17:17'),
(132, 'เป็นหวัด', 500, '2015-11-10', '2015-11-10', '5', 'ดีมาก', 35, 'user19', 4, '2015-11-16 17:17:47'),
(133, 'ไข้หวัด', 2000, '2015-11-02', '2015-11-02', '5', 'ดีมาก', 56, 'user20', 4, '2015-11-16 17:19:20'),
(134, 'คลอด', 3000, '2015-11-03', '2015-11-06', '5', 'บริการดีมาก', 41, 'user20', 7, '2015-11-16 17:20:31'),
(135, 'ประสาทหลอน', 300, '2015-11-18', '2015-11-18', '5', '', 49, 'user26', 22, '2015-11-16 17:21:04'),
(136, 'ไข้หวัดใหญ่', 2000, '2015-11-06', '2015-11-10', '5', 'บรการดีมาก', 48, 'user20', 4, '2015-11-16 17:22:16'),
(137, 'ทำจมูก', 15000, '2015-06-24', '2015-06-25', '5', '', 47, 'user27', 18, '2015-11-16 17:22:25'),
(138, 'ความดัน', 300, '2015-11-25', '2015-11-25', '5', '', 40, 'user28', 37, '2015-11-16 17:24:29'),
(139, 'ปวดหัว', 500, '2015-11-18', '2015-11-18', '5', '', 45, 'user29', 37, '2015-11-16 17:25:59'),
(140, 'งูกัด', 3000, '2015-03-13', '2015-03-17', '5', '', 24, 'user30', 36, '2015-11-16 17:27:32'),
(141, 'ปวดฟัน', 1000, '2015-11-04', '2015-11-04', '5', 'ดีมาก', 46, 'user17', 16, '2015-11-17 13:05:33');
...
CREATE TABLE `medicine` (
  `medicine_id` varchar(30) NOT NULL DEFAULT '' COMMENT 'เลขทะเบียน',
  `medicine_name_th` varchar(255) NOT NULL DEFAULT '' COMMENT 'ชื่อยาภาษาไทย',
  `medicine_name_eng` varchar(255) NOT NULL COMMENT 'ชื่อยาภาษาอังกฤษ',
  `medicine_type` enum('ยาเม็ด','ยาน้ำ','ยาขี้ผึ้งหรือครีม') NOT NULL COMMENT 'รูปแบบของยา',
  `medicine_type_control` enum('ยาสามัญ','ยาอันตราย') NOT NULL COMMENT 'ชนิดของยากฎหมายควบคุม',
  `medicine_detail` text NOT NULL COMMENT 'สรรพคุณ',
  `medicine_chemical` text NOT NULL COMMENT 'สารประกอบสำคัญ',
  `medicine_status` enum('คงอยู่','ยกเลิก') NOT NULL DEFAULT 'คงอยู่' COMMENT 'คงอยู่, ยกเลิก',
  `medicine_use` enum('ภายนอก','ภายใน') NOT NULL COMMENT 'ประเภทของยา',
  `owner_name` varchar(255) NOT NULL COMMENT 'ชื่อผู้รับอนุญาต',
  `company_name` varchar(255) NOT NULL COMMENT 'ชื่อสถานที่ผลิต',
  `company_address` text NOT NULL COMMENT 'ที่ตั้ง',
  `company_province` int(3) NOT NULL,
  `company_amphur` int(3) NOT NULL,
  `company_district` int(3) NOT NULL,
  `company_zipcode` int(5) NOT NULL,
  `tel` text NOT NULL COMMENT 'เบอร์โทรผู้ผลิต',
  `date_added` datetime NOT NULL
...
INSERT INTO `medicine` (`medicine_id`, `medicine_name_th`, `medicine_name_eng`, `medicine_type`, `medicine_type_control`, `medicine_detail`, `medicine_chemical`, `medicine_status`, `medicine_use`, `owner_name`, `company_name`, `company_address`, `company_province`, `company_amphur`, `company_district`, `company_zipcode`, `tel`, `date_added`) VALUES
('', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, '', '2015-11-17 13:01:59'),
('1A 656 2530', 'ยาขับลม', '-', 'ยาน้ำ', 'ยาสามัญ', 'บรรเทาอาการท้องขึ้น ท้องอืด ท้องเฟ้อ และขับลมในกระเพาะอาหาร', 'Capsicum Tincture 0.060-0.500 ml. \r\nCompound Cardamom Tincture 0.035-1.800 ml. \r\nStrong Ginger Tincture 0.024-0.240 ml.', 'คงอยู่', 'ภายใน', '-', '-', '-', 5, 76, 447, 11100, '', '2015-11-03 15:57:28'),
('1A 656/2531', 'พารา ไซรัป', 'PARA SYRUP', 'ยาน้ำ', 'ยาสามัญ', 'บรรเทาอาการปวดสำหรับเด็ก สมมติ', 'PARACETAMOL 120MG', 'คงอยู่', 'ภายใน', 'บริษัท บูรพาโอสถ  จำกัด', 'บริษัท บูรพาโอสถ  จำกัด', '19/19  ม.9   ซ.ทิมแลนด์  ถ.งามวงศ์วาน', 3, 58, 303, 11000, '0 2589 2750-3', '2015-10-31 15:59:23'),
('2A 148/2546', 'ขี้ผึ้งแก้ปวดบวม', '-', 'ยาขี้ผึ้งหรือครีม', 'ยาสามัญ', 'บรรเทาอาการปวดบวมอักเสบเนื่องจากแมลงกัดต่อย หรือปวดเมื่อยกล้ามเนื้อ', 'MENTHOL    10.00 G\r\nMETHYL SALICYLATE    50.00 G\r\nEUCALYPTUS OIL   3.00 G', 'คงอยู่', 'ภายนอก', 'บริษัทมิลลิเมด  จำกัด', 'บริษัท มิลลิเมด  จำกัด', '193  ม.1   ซ.-  ถ.สุขสวัสดิ์', 2, 56, 296, 10290, '0 2461 1027', '2015-10-28 20:27:28'),
('2A 2/2555B', 'เซรุ่มแก้พิษงูระบบประสาท ชนิดเพียวริไฟด์', 'NEURO POLYVALENT SNAKE ANTIVENIN PURIFIED', 'ยาน้ำ', 'ยาอันตราย', 'สำหรับทำลายพิษงูในกลุ่มระบบประสาท ซึ่งได้แก่ งูทับสมิงคลา งูเห่า งูสามเหลี่ยม งูจงอาง ทั้งนี้ขึ้นกับชนิดงูที่กัด', 'ปริมาณ/หน่วย\r\nPURIFIED NEURO POLYVALENT SNAKE ANTIVENIN NEUTRALIZES MALAYAN KRAIT VENOM    -\r\nPURIFIED NEURO POLYVALENT SNAKE ANTIVENIN NEUTRALIZES COBRA VENOM  0.01 g\r\nPURIFIED NEURO POLYVALENT SNAKE ANTIVENIN NEUTRALIZES BANDED KRAIT VENOM  0.001 g\r\nPURIFIED NEURO POLYVALENT SNAKE ANTIVENIN NEUTRALIZES KING COBRA VENOM   qs for osmolarity adjustment', 'คงอยู่', 'ภายใน', 'ภากาชาดไทย', 'สถานเสาวภา สภากาชาดไทย', '1871  ถ.อังรีดูนังต์', 1, 7, 53, 10330, '0 2252 0161', '2015-10-30 14:00:38'),
('2A 70/2529', 'ยาเม็ดบรรเทาอาการไข้หวัด ดี-ไวพ์', 'D-VIPE COLD TABLETS', 'ยาเม็ด', 'ยาอันตราย', 'เป็นยาบรรเทาอาการเนื่องจากไข้หวัดที่มีอาการปวดหัว เป็นไข้ที่เกิดจากการ\r\nแพ้อากาศ อาการคัดจมูก น้ำมูกไหล บรรเทาอาการปวดเมื่อยตามตัว และกล้าม\r\nเนื้อเนื่องจากเป็นไข้หวัด', 'PARACETAMOL 325 MG.\r\nCHLORPHENIRAMINE MALEATE 2 MG.', 'คงอยู่', 'ภายใน', 'บริษัทห้างยาไทย 1942  จำกัด', 'บริษัท ห้างยาไทย 1942 จำกัด', '77  ม.-   ซ.-  ถ.สุขสวัสดิ์', 1, 24, 163, 10140, '0 2427 0020', '2015-10-31 15:57:03'),
('2C 122/2527', 'กลูจีนอน เอช 3', 'GLUGENON+H3', 'ยาเม็ด', 'ยาอันตราย', 'ใช้สำหรับบำรุงร่างกาย บำรุงประสาท', 'TROXERUTIN    3.0 MG.\r\nMAGNESIUM GLUTAMATE  230.0 MG\r\nCHOLINE 6.0 MG.\r\nPROCAINE HCL 50.0 MG.\r\nVITAMIN A PALMITATE 2.500 I.U.\r\nNICOTINAMIDE  10.0 MG\r\nCALCIUM D-PANTOTHENATE   1.0 MG\r\nASCORBIC ACID 10.0 MG\r\nHEMATOPORPHYRIN  0.2 MG\r\nPOTASSIUM SULFATE 12.0 MG\r\nSOYLECITHIN  100.0 MG.\r\nCORN OIL   310.24 MG.\r\nVITAMIN E ( DL - ALPHA TOCOPHERYL ACETATE )   10 I.U.\r\nVITAMIN B1 (THIAMINE MONONITRATE )   1.0 MG\r\nVITAMIN B2 (RIBOFLAVIN)   1.5 MG\r\nVITAMIN B6 (PYRIDOXINE HYDROCHLORIDE) 1.0 MG', 'คงอยู่', 'ภายใน', 'ห้างหุ้นส่วนจำกัดโรเยลดรักส์', 'ห้างหุ้นส่วนจำกัด โรเยลดรักส์', '1631  ม.-   ซ.-  ถ.สุขุมวิท', 6, 93, 658, 10110, '0 2391 3535,0 2391 7936', '2015-10-30 22:45:47'),
('A55T982', 'ยาแก้ปวดฟัน', '-', 'ยาน้ำ', 'ยาสามัญ', 'รักษากระพุ้งแก้มและลิ้นเป็นฝ้าขาว', 'ในสูตรตำรับประกอบด้วยตัวยาสำคัญ คือ\r\n\r\nGentian Violet 1%w/v', 'คงอยู่', 'ภายนอก', '-', '-', 'เกาะสีชัง', 11, 143, 1172, 93400, '0459357813', '2015-11-04 13:48:46'),
('A656T43', 'ยาบรรเทาปวดลดไข้', '-', 'ยาเม็ด', 'ยาสามัญ', '1. ยาเม็ดบรรเทาปวด ลดไข้ แอสไพริน\r\n2. ยาเม็ดบรรเทาปวด ลดไข้ พาราเซตามอล ขนาด 500 มก. และขนาด 325 มก. และยาน้ำ บรรเทาปวดลดไข้ พาราเซตามอล\r\n3. พลาสเตอร์บรรเทาปวด', 'Paracetamol 120 mg.\r\nโดยในสูตรตำรับไม่อนุญาตให้ใช้ Alcohol เป็นส่วนผสม\r\nขวดสีชา 30 มิลลิลิตรในกล่องกระดาษพร้อมหลอดหยด (1.2 มิลลิลิตร) และขวดสีชา 60 มิลลิลิตรในกล่องกระดาษพร้อมช้อนชา', 'คงอยู่', 'ภายใน', '-', '-', 'กรุงเทพมหานคร', 1, 4, 30, 34000, '045-659-4132', '2015-11-04 12:52:39'),
('A6578T43', 'น้ำเกลือล้างแผล', '-', 'ยาน้ำ', 'ยาสามัญ', 'ทำความสะอาดบาดแผล', 'Sodium Chloride 0.9 % w/v', 'คงอยู่', 'ภายนอก', '-', '-', '่นนทบรี', 3, 58, 307, 13500, '0458796315', '2015-11-04 13:39:08'),
('A9656T25', 'ยาเม็ดบรรเทาปวด ลดไข้แอสไพริน', 'Aspirin', 'ยาเม็ด', 'ยาอันตราย', 'ลดไข้ บรรเทาอาการปวด', 'Aspirin 325 mg.\r\nแผงพลาสติกหรืออลูมิเนียมละ4 และ 10 เม็ด', 'คงอยู่', 'ภายใน', 'Px', '-', 'นนทบุรี', 1, 6, 43, 34000, '0458973154', '2015-11-04 12:55:58'),
('ae00045', 'อะมอกซิซิลลิน', 'Amoxicillin', 'ยาเม็ด', 'ยาอันตราย', 'จัดอยู่ในยาปฏิชีวนะกลุ่มเพนิซิลลิน (Penicillins) ถือเป็นยาฆ่าเชื้อแบคทีเรียที่ใช้แพร่หลาย มักเกิดความเข้าใจผิดมากพอสมควร เพราะหลายครั้งผู้ป่วยที่เป็นไข้หวัด/โรคหวัด จะเรียกหาอะมอกซิซิลลินกินแก้เจ็บคอ แต่ไข้หวัดเกิดจากเชื้อไวรัส อะมอกซิซิลลินฆ่าไวรัสไม่ได้ ฆ่าได้แต่แบคทีเรีย', '-', 'คงอยู่', 'ภายใน', 'Asian Pharm', '-', '-', 16, 198, 1606, 34568, '0893456784', '2015-11-04 13:41:39'),
('ae088895', 'คลอกซาซิลลิน', 'Cloxacillin', 'ยาน้ำ', 'ยาสามัญ', 'เป็นยาปฏิชีวนะจัดอยู่ในยากลุ่มยาเพนนิซิลิน (Penicillins)', '-', 'คงอยู่', 'ภายนอก', 'T.O. Chemical', '-', '-', 62, 830, 7543, 19876, '0923456785', '2015-11-04 13:45:27'),
('ag000899', 'อะมิคาซิน', 'Amikacin', 'ยาเม็ด', 'ยาอันตราย', 'ยาปฏิชีวนะ ชนิดหนึ่ง จัดอยู่ในยา กลุ่ม อะมิโนไกลโคไซด์', '-', 'คงอยู่', 'ภายใน', 'Akacin (อะคาซิน)	Atlantic Lab', '-', '-', 18, 211, 1746, 34567, '0875643287', '2015-11-04 13:50:11'),
('ap0087', 'เจนตามัยซิน', 'Genta mycin', 'ยาเม็ด', 'ยาอันตราย', 'ป็นยาปฏิชีวนะใช้รักษาการติดเชื้อแบคทีเรียที่กระดูก ข้อ การติดเชื้อที่ผิวหนัง การติดเชื้อระบบทางเดินหายใจ การติดเชื้อหลังผ่าตัด ยากลุ่มนี้ไม่ค่อยดูดซึมทางลำไส้ ต้องใช้วิธีฉีดเข้ากล้ามหรือฉีดเข้าทางหลอดเลือด มีความเป็นพิษต่อไตและหูชั้นใน', '-', 'คงอยู่', 'ภายใน', 'เภสัชกร อภัย ราษฎรวิจิตร', '-', '567/13 ลาดปลาค้าว เขต มีนบุรี', 1, 10, 74, 46901, '08551342567', '2015-11-04 13:30:51'),
('as98003', 'เตตราไซคลีน', 'Tetracyclines', 'ยาเม็ด', 'ยาอันตราย', 'เป็นยาปฏิชีวนะที่ถูกสังเคราะห์ขึ้น เพื่อใช้รักษาโรคในผู้ป่วยที่มีการติดเชื้อแบคทีเรีย และมีการใช้ยาตัวนี้ยาวนานเกือบ 70 ปี ในอดีตถูกนำไปใช้รักษาอหิวาตกโรค วงการแพทย์ยังนำยานี้มาใช้รักษาสิว หลอดลมอักเสบ กามโรค เช่น ซิฟิลิส', '-', 'คงอยู่', 'ภายใน', 'U.S. Summi', '-', '-', 4, 68, 375, 32908, '0812456784', '2015-11-04 13:38:39'),
('aw34778', 'โทบรามัยซิน', 'Tobramycin', 'ยาเม็ด', 'ยาอันตราย', 'ถูกพัฒนามาจากเชื้อแบคทีเรียชื่อ Streptomyces tene brarius เป็นยาปฏิชีวนะกลุ่ม Aminoglycoside มีฤทธิ์ในการต้านเชื้อแบคทีเรียหลายชนิด', '-', 'คงอยู่', 'ภายใน', 'DW Tobramycin (ดีดับเบิ้ลยู โทบรามัยซิน)', '-', '-', 2, 54, 270, 34598, '0987765432', '2015-11-04 13:47:37'),
('ax90008', 'อะมิโนไกลโคไซด์', 'Aminoglycosides', 'ยาเม็ด', 'ยาอันตราย', 'เป็นยาปฏิชีวนะใช้รักษาการติดเชื้อแบคทีเรียที่กระดูก ข้อ การติดเชื้อที่ผิวหนัง การติเชื้อระบบทางเดินหายใจ การติดเชื้อหลังผ่าตัด ยากลุ่มนี้ไม่ค่อยดูดซึมทางลำไส้ ต้องใช้วิธีฉีดเข้ากล้ามหรือฉีดเข้าทางหลอดเลือด มีความเป็นพิษต่อไตและหูชั้นใน', '-', 'คงอยู่', 'ภายใน', '-', '-', '745/1 เจริญนคร แขวงบางลำภูล่าง เขต คลองสาน', 1, 18, 121, 42081, '0988882354', '2015-11-04 13:25:03'),
('er008742', 'เซฟาโลสปอริน', 'Cephalosporin', 'ยาเม็ด', 'ยาอันตราย', 'จัดเป็นกลุ่มยาปฏิชีวนะที่ออกฤทธิ์ต้านเชื้อแบคทีเรียได้หลายชนิด เช่น ชนิดก่อการอักเสบของทางเดินหายใจ และของทางเดินอา หาร ยากลุ่มนี้ไม่ทนกรดเช่นเดียวกับกลุ่มเพนิซิลลิน (Penicillin) และดูดซึมในทางเดินอาหารได้ไม่ดี จึงต้องใช้การฉีดเข้ากล้ามหรือเข้าหลอดเลือด แต่ก็พบว่ายาเซฟาโลสปอรินบางตัวมีคุณสมบัติทนกรดได้ดี ทั้งยังสามารถให้ยาโดยการรับประทานได้', '-', 'คงอยู่', 'ภายใน', 'เภสัชกร อภัย ราษฎรวิจิตร', '-', '-', 5, 79, 497, 34567, '0984567348', '2015-11-04 13:33:34'),
('fx545s', 'ยาเม็ดบรรเทาปวด ลดไข้พาราเซตามอล 500 มก.', '-', 'ยาเม็ด', 'ยาอันตราย', 'Paracetamol 500 mg', 'ลดไข้ บรรเทาอาการปวด', 'คงอยู่', 'ภายใน', '1-5-78265-898', '-', 'ปราจีนบุรี', 16, 194, 1573, 53400, '0459852357', '2015-11-04 13:23:43'),
('kj000345', 'สเตรปโตมัยซิน', 'Streptomycin', 'ยาเม็ด', 'ยาอันตราย', 'ตัวยาถูกนำมาใช้รักษาวัณโรคและยังครอบคลุมถึงเชื้อแบคทีเรีย', '-', 'คงอยู่', 'ภายนอก', 'Strepto (สเตรปโต)', '-', '-', 3, 60, 322, 80977, '0987664642', '2015-11-04 13:53:02'),
('ps 2754300', 'ยาแก้แพ้ ลดน้ํามูก', '-', 'ยาเม็ด', 'ยาอันตราย', 'ใช้เวลาที่มีอาการนอนไม่หลับ', '- ห้ามใช้ในเด็กอายุต่ํากว่า 1 ปี ผู้ที่\r\nกําลังมีอาการหอบหืด โรคต้อหิน\r\nต่อมลูกหมากโต หรือปัสสาวะขัด\r\nนอกจากแพทย์สั่ง', 'คงอยู่', 'ภายใน', '-', '-', '-', 1, 3, 23, 31000, '', '2015-11-07 15:50:10'),
('px0089', 'ยาเพนิซิลลิน', 'Penicillin', 'ยาเม็ด', 'ยาอันตราย', 'เป็นยาใช้รักษาการติดเชื้อแบคทีเรียได้ในหลายเนื้อเยื่อ/อวัยวะ เช่น คออักเสบ เป็นต้น', '-', 'คงอยู่', 'ภายใน', '-', '-', '-', 2, 53, 262, 45001, '0891234441', '2015-11-04 13:20:05'),
('Px2487rt', 'คลอร์เฟนิรามีน', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการแพ้ เช่น ลมพิษ น้ำมูกไหล', 'Chlorpheniramine Maleate 2 mg.', 'คงอยู่', 'ภายใน', '-', '-', 'จันทบุรี', 13, 162, 1301, 56220, '0457915434', '2015-11-04 13:26:00'),
('Px4546rt', 'ยาระบาย', '-', 'ยาเม็ด', 'ยาอันตราย', 'Glycerin 91 % w/w', 'สำหรับบรรเทาอาการท้องผูก ใช้เหน็บทวารหนักเพื่อช่วยการขับถ่าย', 'คงอยู่', 'ภายใน', '1-2-08-17-11-00002', '-', 'กทม', 1, 6, 47, 10300, '0457863387', '2015-11-04 13:20:27'),
('Px5323', 'ยาอมบรรเทาอาการระคายคอ', '-', 'ยาเม็ด', 'ยาอันตราย', 'ทำให้ชุ่มคอ บรรเทาอาการระคายคอ\r\nขนาดและวิธีใช้	ใช้อมให้ละลายช้าๆ ครั้งละ 1-5 เม็ด (โดยให้คณะอนุกรรมการ พิจารณาตำรับยา แผนปัจจุบัน ที่ใช้ สำหรับมนุษย์พิจารณา ตามขนาดที่ถูกต้อง ตามสูตรตำรับที่ผู้รับอนุญาต ขอขึ้นทะเบียนตำรับยา)\r\nการเก็บรักษา	เก็บในที่แห้งและเย็น\r\nขนาดบรรจุ	ไม่เกิน 100 เม็ด หรือ ไม่เกิน 30 กรัม', 'ในสูตรตำรับประกอบด้วยตัวยาสำคัญ คือ Volatile Substance ที่มีสรรพคุณทางยา และ/หรือ Herbal Extract และ/หรือ Herbal Substance หนึ่งหรือหลายชนิดผสมกัน ได้แก่\r\n\r\nAbietis Pine Oil 0.30%v/w \r\nAnise Oil 0.25%w/w \r\nBorneol 1.66-2.00%w/w \r\nCinnamon Oil 0.35%w/w \r\nCreosote 0.20%v/w \r\nEucalyptus Oil 0.15-0.16%w/w \r\nLemon Oil 0.30-0.52%v/w \r\nMenthol 0.06-5.00%w/w \r\nPeppermint Oil 0.19-3.33%w/w \r\nSylvestris Pine Oil 0.30%v/w \r\nLicorice Extract 7.31-16.67%w/w \r\nTincture Capsicum 0.02%w/w \r\nAmomum 1.00-4.00%w/w \r\nAniseed 2.00%w/w \r\nCatechu 8.33-38.00%w/w \r\nCinnamon 2.00-10.00%w/w \r\nClove 0.67-4.00%w/w \r\nCostus 0.67%w/w \r\nFennel 1.67-2.00%w/w \r\nGinger 2.00-8.00%w/w \r\nLicorice 26.67-71.38%w/w \r\nSaffron 2.00%w/w \r\nSaussurea 1.00 - 3.00%w/w \r\nSilver Leaf 0.93%w/w \r\nและ/หรือ Honey 1.50-2.40%w/w', 'คงอยู่', 'ภายใน', '-', '-', 'ปทุมธานี', 4, 67, 368, 67800, '0457611147', '2015-11-04 13:51:32'),
('Px5482Gt', 'ยาหยอดตา ซัลฟาเซตาไมด์', '-', 'ยาน้ำ', 'ยาอันตราย', 'รักษาอาการตาแดง ตาอักเสบ จากโรคติดเชื้อ', 'Sulfacetamide Sodium 10 % w/v', 'คงอยู่', 'ภายนอก', '-', '-', 'บ่อทราย', 15, 184, 1493, 54900, '0453682105', '2015-11-04 13:29:41'),
('px56433', 'ยาแก้ปวดท้อง ท้องอืด ท้องขึ้น ท้องเฟ้อ', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการปวดท้อง\r\nเนื่ อ งจ า ก จุ ก เสี ย ด ท้ อ งขึ้ น\r\nท้องเฟ้อ', '- ค ว า ม ใ ช้ ย า นี้ ด้ ว ย ค ว า ม\r\nระมัดระวังในผู้ป่วยโรคความดัน\r\nโลหิตสูง\r\n- ห้ า ม ใ ช้ ร่ ว ม กั บ อ า ห า ร ที่ มี\r\nแคลเซียมสูง เช่น นม หรือยาลด\r\nกรดแคลเซียมคาร์บอเนต', 'คงอยู่', 'ภายใน', '-', '-', '-', 14, 172, 1379, 39300, '', '2015-11-07 15:51:53'),
('px5656', 'ปิเปอราซีน', '-', 'ยาเม็ด', 'ยาอันตราย', 'ใช้ในการถ่ายพยาธิ', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 10, 128, 1025, 34900, '', '2015-11-07 15:54:35'),
('Px5687', 'ยาเม็ดวิตามินรวม', '-', 'ยาเม็ด', 'ยาอันตราย', 'ป้องกันการขาดวิตามินสำหรับผู้ใหญ่', 'ในสูตรตำรับ 1 เม็ด ประกอบด้วยตัวยาสำคัญ คือ\r\n\r\nVitamin A 2,500 I.U. \r\nVitamin D 300 I.U. \r\nVitamin C 15.00 mg. \r\nVitamin B1 Mononitrate 1.00 mg. \r\nVitamin B2 0.50 mg. \r\nNicotinamide 7.50 mg.', 'คงอยู่', 'ภายใน', '-', '-', 'ตลิ่งชัน', 5, 79, 510, 35200, '0459783254', '2015-11-04 13:44:33'),
('Px5784rt', 'ยาหม่อง ชนิดขี้ผึ้ง', '-', 'ยาขี้ผึ้งหรือครีม', 'ยาสามัญ', 'บรรเทาอาการปวด บวม อักเสบ เนื่องจากแมลงกัดต่อย หรือปวดเมื่อยกล้ามเนื้อ', 'Volatile Substance ที่มีสรรพคุณทางยา และ/หรือ Herbal Extract หนึ่งหรือหลายชนิดผสมกันได้แก่\r\n\r\nMethyl Salicylate 1.14-50.00%w/w \r\nCamphor 1.76-25.00%w/w \r\nMenthol 3.00-20.00%w/w \r\nCinnamon Oil 1.00-2.40%w/w \r\nClove Oil 0.50-5.00%v/w \r\nEucalyptus Oil 1.50-13.70%v/w \r\nPeppermint Oil 0.70-16.00%w/w \r\nTerpentine Oil 2.00-3.80%v/w \r\nCapsicum Tincture 0.80-8.00%v/v \r\nColophony 2.51%v/w', 'คงอยู่', 'ภายนอก', '-', '-', 'ท่าดินดำ', 7, 100, 770, 56220, '0452456467', '2015-11-04 13:42:15'),
('px58766', 'รีเซอร์พีน', '(Rauwolfia serpentina)', 'ยาน้ำ', 'ยาสามัญ', 'ยานี้ออกฤทธิ์ต้านประสาทซิมพาเทติกส่วนปลาย ใช้รักษาโรคความดันสูง ที่ยังไม่มีภาวะแทรกซ้อนรุนแรง', '', 'คงอยู่', 'ภายนอก', '-', '-', '-', 14, 173, 1385, 34900, '', '2015-11-07 16:00:34'),
('px86785', 'ยานอนหลับ', '-', 'ยาเม็ด', 'ยาอันตราย', 'กินเวลานอนไม่หลับ', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 3, 61, 328, 32800, '', '2015-11-07 16:06:56'),
('Rx865u', 'ยาเม็ดวิตามินบีรวม', '-', 'ยาเม็ด', 'ยาสามัญ', 'ป้องกันการขาดวิตามินบี และบำรุงร่างกาย', 'Thiamine Hydrochloride or Thiamine Mononitrate 5 mg. \r\nPyridoxine Hydrochloride 2 mg. \r\nRiboflavine 2 mg. \r\nNicotinamide 20 mg.', 'คงอยู่', 'ภายใน', 'ขนส่งเภสัช', '-', 'เลขที่ 183/13 หมู่ 4 ซอย ถนน สวนผัก แขวงตลิ่งชัน', 1, 17, 115, 10170, '0 2886 7336', '2015-11-04 13:12:40'),
('wa67009', 'ยาแอมปิซิลลิน', '(Ampicillin', 'ยาเม็ด', 'ยาอันตราย', 'เป็นยาปฏิชีวนะชนิดหนึ่งจัดอยู่ในกลุ่มยาเพนนิซิลลิน(Penicillins) เป็นยาที่ใช้กันมานานมากกว่า 90 ปี มีฤทธิ์ต้านเชื้อแบคทีเรียได้หลายชนิดเช่น กลุ่มสแตปฟีโลคอคไค (Staphylococci) สเตปโตคอคไค (Steptococci) เอช อินฟลูเอนซา(H. Influenza) โคลิฟอร์ม (Coliforms) และโปรเตียส (Proteus )', '-', 'คงอยู่', 'ภายใน', 'Vitrofarma SA', '-', '-', 3, 60, 322, 20897, '0843244357', '2015-11-04 13:43:17'),
('wg98007', 'แมคโครไลด์', 'Macrolide', 'ยาเม็ด', 'ยาอันตราย', 'ยากลุ่มแมคโครไลด์ (Macrolide) เป็นสารที่มีโครงสร้างเคมีของ Macrolide ring ที่เป็นสารในยาปฏิชีวนะหลายชนิดเป็นองค์ประกอบหลัก ในธรรมชาติจะพบเห็นสารประเภทแมคโครไลด์ที่อยู่ในหมวดยาปฏิชีวนะที่ได้จากแบคทีเรียที่อาศัยในดินกลุ่มสเตรปโตมัยซีส (Streptomycetes) นอกจากนี้ยังมีกลุ่มยาที่มีโครงสร้างทางเคมีเป็น Macrolide ring แต่มีประโยชน์ทางการแพทย์ที่แตกต่างกันออกไปอีกเช่น ใช้เป็นยาต้านเชื้อรา ใช้เป็นยากดภูมิคุ้มกันต้านทานโรคในผู้ป่วยที่ต้องเปลี่ยนถ่ายอวัยวะ', 'Azithromycin, Clarithromycin, Erythromycin, Telithromycin, Carbomycin A, Josamycin, Kitasamycin, Midecamycin, Midecamycin acetate, Oleandomycin', 'คงอยู่', 'ภายใน', 'M & H Manufacturing', '-', '-', 10, 124, 975, 35687, '0865453245', '2015-11-04 13:36:13'),
('ข.ล.02400', 'ยาลดไขมันในเลือด', '-', 'ยาเม็ด', 'ยาอันตราย', 'ช่วยลดไขมันในเลือด', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 10, 126, 1008, 34001, '0450230176', '2015-11-16 16:50:58'),
('น.849375', 'แก้ปวด', '(Analgesics/อะนัลเจสิค)', 'ยาเม็ด', 'ยาอันตราย', 'ยังยั้งฤทธิ์ของสารในร่างกายที่หลั่งออกมาและทำให้รู้สึกปวดเช่น ปวดหัว/ปวดศีรษะ ปวดฟัน ปวดกล้ามเนื้อ ปวดกระดูก ปวดท้อง ปวดข้อ และปวดหลัง', 'ยาไอบูโปรเฟน (Ibuprofen) ยาไดโคฟีแนค (Diclofenac) ยาเมเฟนามิค (Mefenamic) ยาอินโดเมธาซิน (Indomethacin) ยาไพโรซิแคม (Piroxicam) และ ยานิมีซูไลด์ (Nimesulide)', 'คงอยู่', 'ภายใน', 'Jenssen – Cilag/DKSH', 'Thailand', 'MIMS Thailand . TIMS. 110th Ed 2008.', 1, 5, 40, 34100, '0899584432', '2015-11-15 15:05:28'),
('น.พ.02498300', 'ยาแก้ปวดประจำเดือน', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการปวดประจำเดือน', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 6, 92, 648, 34850, '0245578014', '2015-11-16 16:53:03'),
('น.ล.0645', 'ยาฆ่าเชื้อ', '-', 'ยาเม็ด', 'ยาอันตราย', 'ใช้ฆ่าเชื้อในร่างกาย', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 11, 138, 1113, 93500, '0457892500', '2015-11-16 17:15:52'),
('พ.น.02500', 'เกลือแร่', '-', 'ยาน้ำ', 'ยาอันตราย', 'บรรเทาอาการท้องร่วง', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 4, 69, 383, 34090, '0452970245', '2015-11-16 16:38:37'),
('พ.บ.1347800', 'ยาระงับประสาท', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการระงับประสาท', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 11, 139, 1118, 30140, '0452034500', '2015-11-16 17:19:45'),
('พ.บ.46200', 'ยาหยอดตา', '-', 'ยาน้ำ', 'ยาอันตราย', 'ใช้หยอดตาเวลาที่มีอาการระคายเคือง', '', 'คงอยู่', 'ภายนอก', '-', '-', '-', 8, 111, 875, 35400, '0453975850', '2015-11-16 16:34:27'),
('พ.บ014555', 'เสมหะ', '-', 'ยาน้ำ', 'ยาอันตราย', 'ละลายเสมหะ', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 12, 152, 1204, 25450, '0452301700', '2015-11-16 16:46:47'),
('ย.00784', 'ยาแก้แพ้', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการแพ้ ลมพิศ ผื่น', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 6, 92, 651, 64420, '0453678595', '2015-11-16 16:31:09'),
('ร.น.245455', 'ยาแก้ท้องเสีย', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการท้องเสียได้', '', 'คงอยู่', 'ภายใน', '-', '-', 'ปทุม', 4, 66, 360, 34880, '0458973000', '2015-11-16 16:28:32'),
('ร.พ.20800', 'แก้อักเสบ', '-', 'ยาเม็ด', 'ยาอันตราย', 'บรรเทาอาการอักเสบ', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 5, 77, 462, 34600, '0459835700', '2015-11-16 16:58:26'),
('ร.พ0246578', 'ยาลดความดันโลหิต', '-', 'ยาเม็ด', 'ยาอันตราย', 'ยานี้เหมาะสำหรับผู้ป่วยความดันโลหิตสูง', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 10, 128, 1025, 30480, '0454565352', '2015-11-16 16:43:45'),
('อ.02400', 'แก้ไอ', '-', 'ยาน้ำ', 'ยาอันตราย', 'บรรเทาอาการไอ', '', 'คงอยู่', 'ภายใน', '-', '-', '-', 7, 101, 796, 34180, '0453287012', '2015-11-16 16:47:56');
...
CREATE TABLE `medicine_order` (
  `medicine_order_id` int(11) NOT NULL,
  `medicine_id` varchar(20) NOT NULL DEFAULT '',
  `medical_id` varchar(10) NOT NULL DEFAULT '',
  `date_added` datetime NOT NULL
...
INSERT INTO `medicine_order` (`medicine_order_id`, `medicine_id`, `medical_id`, `date_added`) VALUES
(4, '1A 656/2531', '1', '2015-11-06 12:18:49'),
(5, 'A656T43', '1', '2015-11-06 12:18:49'),
(6, 'Px5687', '0', '2015-11-07 12:52:07'),
(7, 'Px5687', '4', '2015-11-07 12:53:10'),
(8, '1A 656/2531', '5', '2015-11-07 14:17:08'),
(9, '2A 70/2529', '5', '2015-11-07 14:17:08'),
(10, 'A656T43', '5', '2015-11-07 14:17:08'),
(11, 'ae00045', '5', '2015-11-07 14:17:08'),
(12, '1A 656/2531', '6', '2015-11-07 14:18:58'),
(13, '2A 148/2546', '6', '2015-11-07 14:18:58'),
(14, 'Rx865u', '6', '2015-11-07 14:18:58'),
(15, 'A55T982', '7', '2015-11-07 14:21:16'),
(16, 'Px5687', '8', '2015-11-07 14:23:33'),
(17, 'A656T43', '8', '2015-11-07 14:23:33'),
(18, 'Rx865u', '9', '2015-11-07 14:26:50'),
(19, 'Rx865u', '10', '2015-11-07 14:28:23'),
(20, 'A9656T25', '10', '2015-11-07 14:28:23'),
(21, 'Px2487rt', '10', '2015-11-07 14:28:23'),
(22, 'er008742', '10', '2015-11-07 14:28:23'),
(23, '1A 656/2531', '11', '2015-11-07 14:28:28'),
(24, 'fx545s', '11', '2015-11-07 14:28:28'),
(25, '1A 656/2531', '12', '2015-11-07 14:30:17'),
(26, 'A9656T25', '12', '2015-11-07 14:30:17'),
(27, 'A656T43', '13', '2015-11-07 14:34:05'),
(28, 'A9656T25', '13', '2015-11-07 14:34:05'),
(29, '1A 656 2530', '14', '2015-11-07 14:37:08'),
(30, 'wa67009', '14', '2015-11-07 14:37:08'),
(31, 'A6578T43', '15', '2015-11-07 14:37:54'),
(32, 'ap0087', '15', '2015-11-07 14:37:54'),
(33, 'fx545s', '15', '2015-11-07 14:37:54'),
(34, 'wa67009', '15', '2015-11-07 14:37:54'),
(35, 'fx545s', '16', '2015-11-07 14:39:02'),
(36, 'A9656T25', '16', '2015-11-07 14:39:02'),
(37, 'ag000899', '17', '2015-11-07 14:40:42'),
(38, 'aw34778', '17', '2015-11-07 14:40:42'),
(39, 'er008742', '17', '2015-11-07 14:40:42'),
(40, 'ap0087', '18', '2015-11-07 14:42:02'),
(41, 'Px5687', '19', '2015-11-07 14:43:36'),
(42, '1A 656 2530', '19', '2015-11-07 14:43:36'),
(43, 'A6578T43', '20', '2015-11-07 14:45:26'),
(44, 'ae00045', '20', '2015-11-07 14:45:26'),
(45, '1A 656/2531', '21', '2015-11-07 14:53:40'),
(46, 'A656T43', '21', '2015-11-07 14:53:40'),
(47, 'A9656T25', '23', '2015-11-07 15:04:01'),
(48, 'A6578T43', '24', '2015-11-07 15:06:58'),
(49, 'px0089', '24', '2015-11-07 15:06:58'),
(50, '2A 148/2546', '25', '2015-11-07 15:07:17'),
(51, 'A55T982', '26', '2015-11-07 15:08:37'),
(52, 'Rx865u', '27', '2015-11-07 15:09:05'),
(53, '1A 656 2530', '28', '2015-11-07 15:10:46'),
(54, 'as98003', '28', '2015-11-07 15:10:46'),
(55, 'kj000345', '28', '2015-11-07 15:10:46'),
(56, '2C 122/2527', '28', '2015-11-07 15:10:46'),
(57, 'fx545s', '28', '2015-11-07 15:10:46'),
(58, 'kj000345', '30', '2015-11-07 15:12:41'),
(59, 'ax90008', '30', '2015-11-07 15:12:41'),
(60, 'A6578T43', '30', '2015-11-07 15:12:41'),
(61, 'as98003', '30', '2015-11-07 15:12:41'),
(62, 'A6578T43', '31', '2015-11-07 15:12:48'),
(63, '2A 148/2546', '31', '2015-11-07 15:12:48'),
(64, '2A 148/2546', '32', '2015-11-07 15:14:26'),
(65, 'A656T43', '32', '2015-11-07 15:14:26'),
(66, 'A9656T25', '33', '2015-11-07 15:14:35'),
(67, 'aw34778', '33', '2015-11-07 15:14:35'),
(68, 'kj000345', '33', '2015-11-07 15:14:35'),
(69, 'ag000899', '33', '2015-11-07 15:14:35'),
(70, '1A 656 2530', '34', '2015-11-07 15:16:51'),
(71, 'wa67009', '34', '2015-11-07 15:16:51'),
(72, '2A 148/2546', '36', '2015-11-07 15:19:42'),
(73, 'Px5784rt', '36', '2015-11-07 15:19:42'),
(74, '2A 70/2529', '37', '2015-11-07 15:30:51'),
(75, 'aw34778', '38', '2015-11-07 15:34:10'),
(76, 'kj000345', '38', '2015-11-07 15:34:10'),
(77, '1A 656 2530', '39', '2015-11-07 15:34:16'),
(78, 'Px4546rt', '39', '2015-11-07 15:34:16'),
(79, 'A55T982', '40', '2015-11-07 15:36:47'),
(80, 'Px5687', '41', '2015-11-07 15:38:25'),
(81, 'Px4546rt', '42', '2015-11-07 15:39:01'),
(82, 'px0089', '43', '2015-11-07 15:41:15'),
(83, 'A9656T25', '43', '2015-11-07 15:41:15'),
(84, '2A 70/2529', '44', '2015-11-07 15:41:42'),
(85, '1A 656 2530', '45', '2015-11-07 15:42:15'),
(86, '1A 656/2531', '45', '2015-11-07 15:42:15'),
(87, 'kj000345', '46', '2015-11-07 15:42:42'),
(88, 'fx545s', '46', '2015-11-07 15:42:42'),
(89, '2A 148/2546', '46', '2015-11-07 15:42:42'),
(90, '2C 122/2527', '46', '2015-11-07 15:42:42'),
(91, '1A 656/2531', '47', '2015-11-07 15:43:10'),
(92, '2A 148/2546', '48', '2015-11-07 15:43:54'),
(93, 'Px2487rt', '49', '2015-11-07 15:45:16'),
(94, 'ax90008', '49', '2015-11-07 15:45:16'),
(95, '1A 656 2530', '50', '2015-11-07 15:45:50'),
(96, '1A 656 2530', '51', '2015-11-07 15:47:28'),
(97, 'as98003', '51', '2015-11-07 15:47:28'),
(98, '2C 122/2527', '51', '2015-11-07 15:47:28'),
(99, 'ag000899', '52', '2015-11-07 15:49:04'),
(100, 'kj000345', '52', '2015-11-07 15:49:04'),
(101, 'ax90008', '52', '2015-11-07 15:49:04'),
(102, 'px86785', '53', '2015-11-07 16:08:41'),
(103, 'A656T43', '56', '2015-11-11 12:44:53'),
(104, 'A55T982', '57', '2015-11-11 15:06:05'),
(105, 'px0089', '58', '2015-11-11 15:06:51'),
(106, 'Px5687', '60', '2015-11-11 15:08:06'),
(107, '1A 656/2531', '62', '2015-11-11 15:13:39'),
(108, '2A 148/2546', '62', '2015-11-11 15:13:39'),
(109, 'Px5687', '64', '2015-11-11 15:19:06'),
(110, 'Px5687', '66', '2015-11-11 15:20:43'),
(111, '1A 656 2530', '67', '2015-11-11 15:21:54'),
(112, 'Rx865u', '69', '2015-11-11 15:23:30'),
(113, 'Px5687', '71', '2015-11-11 15:28:02'),
(114, '1A 656 2530', '74', '2015-11-11 15:30:39'),
(115, 'Px5687', '76', '2015-11-11 15:31:43'),
(116, 'Rx865u', '78', '2015-11-11 15:32:37'),
(117, 'Rx865u', '80', '2015-11-11 15:33:22'),
(118, 'Rx865u', '82', '2015-11-11 15:34:19'),
(119, 'Rx865u', '83', '2015-11-11 15:35:15'),
(120, 'Rx865u', '85', '2015-11-11 15:36:09'),
(121, 'Rx865u', '87', '2015-11-11 15:37:16'),
(122, 'Rx865u', '89', '2015-11-11 15:38:49'),
(123, '1A 656/2531', '89', '2015-11-11 15:38:49'),
(124, 'Rx865u', '91', '2015-11-11 15:40:48'),
(125, 'Rx865u', '92', '2015-11-15 14:40:32'),
(126, '1A 656/2531', '93', '2015-11-16 16:21:03'),
(127, 'A656T43', '93', '2015-11-16 16:21:03'),
(128, 'px56433', '94', '2015-11-16 16:24:17'),
(129, '1A 656 2530', '94', '2015-11-16 16:24:17'),
(130, '1A 656 2530', '95', '2015-11-16 16:27:35'),
(131, 'px56433', '95', '2015-11-16 16:27:35'),
(132, 'A55T982', '96', '2015-11-16 16:30:25'),
(133, 'px0089', '96', '2015-11-16 16:30:25'),
(134, '1A 656/2531', '97', '2015-11-16 16:34:25'),
(135, 'น.849375', '97', '2015-11-16 16:34:25'),
(136, 'A9656T25', '98', '2015-11-16 16:40:12'),
(137, 'Px5323', '98', '2015-11-16 16:40:12'),
(138, '1A 656/2531', '99', '2015-11-16 16:42:20'),
(139, 'A656T43', '99', '2015-11-16 16:42:20'),
(140, 'Px5687', '99', '2015-11-16 16:42:20'),
(141, 'ag000899', '101', '2015-11-16 16:44:09'),
(142, 'kj000345', '101', '2015-11-16 16:44:09'),
(143, '1A 656/2531', '102', '2015-11-16 16:46:13'),
(144, 'A656T43', '102', '2015-11-16 16:46:13'),
(145, 'ร.พ0246578', '103', '2015-11-16 16:47:24'),
(146, 'A9656T25', '104', '2015-11-16 16:48:07'),
(147, '2A 148/2546', '105', '2015-11-16 16:48:37'),
(148, 'ร.พ.20800', '105', '2015-11-16 16:48:37'),
(149, '1A 656/2531', '106', '2015-11-16 16:49:45'),
(150, '1A 656/2531', '107', '2015-11-16 16:50:23'),
(151, 'ps 2754300', '107', '2015-11-16 16:50:23'),
(152, 'ย.00784', '108', '2015-11-16 16:51:19'),
(153, '2A 148/2546', '109', '2015-11-16 16:52:01'),
(154, 'ย.00784', '109', '2015-11-16 16:52:01'),
(155, 'พ.บ.46200', '110', '2015-11-16 16:54:14'),
(156, 'ร.พ.20800', '111', '2015-11-16 16:54:22'),
(157, 'wg98007', '111', '2015-11-16 16:54:22'),
(158, '1A 656/2531', '112', '2015-11-16 16:56:04'),
(159, 'ร.พ.20800', '112', '2015-11-16 16:56:04'),
(160, 'A656T43', '112', '2015-11-16 16:56:04'),
(161, 'พ.บ.46200', '113', '2015-11-16 16:56:39'),
(162, 'ร.พ.20800', '113', '2015-11-16 16:56:39'),
(163, 'A55T982', '114', '2015-11-16 16:57:56'),
(164, 'ร.พ.20800', '114', '2015-11-16 16:57:56'),
(165, 'A656T43', '115', '2015-11-16 16:58:29'),
(166, '2A 148/2546', '115', '2015-11-16 16:58:29'),
(167, 'ร.พ.20800', '116', '2015-11-16 17:00:40'),
(168, 'พ.บ.46200', '116', '2015-11-16 17:00:40'),
(169, 'Rx865u', '117', '2015-11-16 17:01:33'),
(170, '1A 656/2531', '117', '2015-11-16 17:01:33'),
(171, '1A 656/2531', '118', '2015-11-16 17:02:55'),
(172, 'Px2487rt', '118', '2015-11-16 17:02:55'),
(173, '2A 148/2546', '119', '2015-11-16 17:04:16'),
(174, 'A6578T43', '119', '2015-11-16 17:04:16'),
(175, 'ร.พ.20800', '119', '2015-11-16 17:04:16'),
(176, 'ร.พ0246578', '120', '2015-11-16 17:05:14'),
(177, 'ร.พ0246578', '121', '2015-11-16 17:05:49'),
(178, '1A 656/2531', '122', '2015-11-16 17:07:25'),
(179, 'ย.00784', '122', '2015-11-16 17:07:25'),
(180, 'ร.น.245455', '123', '2015-11-16 17:11:03'),
(181, 'พ.น.02500', '123', '2015-11-16 17:11:03'),
(182, 'ร.พ.20800', '124', '2015-11-16 17:11:47'),
(183, '1A 656/2531', '124', '2015-11-16 17:11:47'),
(184, 'A6578T43', '124', '2015-11-16 17:11:47'),
(185, 'A55T982', '125', '2015-11-16 17:12:24'),
(186, 'Px5687', '126', '2015-11-16 17:13:42'),
(187, 'ข.ล.02400', '127', '2015-11-16 17:14:00'),
(188, 'Px5482Gt', '128', '2015-11-16 17:14:46'),
(189, 'ร.พ.20800', '128', '2015-11-16 17:14:46'),
(190, '1A 656/2531', '129', '2015-11-16 17:14:57'),
(191, 'ax90008', '130', '2015-11-16 17:15:45'),
(192, 'ร.พ.20800', '130', '2015-11-16 17:15:45'),
(193, 'ย.00784', '131', '2015-11-16 17:17:17'),
(194, 'A656T43', '132', '2015-11-16 17:17:47'),
(195, 'A656T43', '133', '2015-11-16 17:19:20'),
(196, 'น.849375', '133', '2015-11-16 17:19:20'),
(197, 'ร.พ.20800', '134', '2015-11-16 17:20:31'),
(198, 'พ.บ.1347800', '135', '2015-11-16 17:21:04'),
(199, '1A 656/2531', '136', '2015-11-16 17:22:16'),
(200, 'ps 2754300', '136', '2015-11-16 17:22:16'),
(201, 'น.ล.0645', '136', '2015-11-16 17:22:16'),
(202, '1A 656/2531', '137', '2015-11-16 17:22:25'),
(203, 'ร.พ0246578', '138', '2015-11-16 17:24:29'),
(204, '2A 70/2529', '139', '2015-11-16 17:25:59'),
(205, '2A 2/2555B', '140', '2015-11-16 17:27:32'),
(206, 'A55T982', '141', '2015-11-17 13:05:33');
...
CREATE TABLE `profile` (
  ...
  `profile_pwd` varchar(12) NOT NULL DEFAULT '',
  `firstname` varchar(100) NOT NULL DEFAULT '',
  `lastname` varchar(100) NOT NULL DEFAULT '',
  `age` int(3) NOT NULL,
  `title` varchar(100) NOT NULL DEFAULT '' COMMENT 'คำนำหน้าชื่อ',
  ...
  `amphur` int(3) NOT NULL,
  `district` int(3) NOT NULL,
  `zipcode` int(5) NOT NULL,
  `lat` varchar(100) DEFAULT NULL,
  `lng` varchar(100) DEFAULT '',
  `date_added` datetime NOT NULL,
  `privacy` enum('0','1') DEFAULT '1' COMMENT 'public user or not',
...
INSERT INTO `profile` (`profile_id`, `profile_username`, `profile_pwd`, `firstname`, `lastname`, `age`, `title`, `gender`, `birthday`, `tel`, `email`, `address`, `province`, `amphur`, `district`, `zipcode`, `lat`, `lng`, `date_added`, `privacy`, `last_login`) VALUES
(7, 'user1', '1234', 'รมิตา', 'จิระกิจอนันต์', 25, 'นางสาว', 'F', '1990-10-10', '0877797910', 'p_ramij@hotmail.com', '439 ถ.สรรพสิทธิ์', 23, 312, 2788, 34000, '', '', '2015-11-01 17:14:30', '1', '0000-00-00 00:00:00'),
(8, 'user2', '1234', 'Surachet', 'Kobsawat', 27, 'นาย', 'M', '1988-06-07', '0988884443', 'surachet@gmail.com', '5 หมู่ 1', 23, 312, 2788, 34000, '', '', '2015-11-01 17:18:47', '1', '0000-00-00 00:00:00'),
(9, 'user3', '1234', 'ต้อง', 'กรุณ', 26, 'นาย', 'M', '1988-12-21', '0875435550', 'karoon@outlook.com', '122 ถนนสรรพสิทธิ์', 5, 76, 445, 60000, '101.012312312312313', '291.012312312312313', '2015-11-01 17:41:26', '0', '2015-11-03 20:35:16'),
(18, 'user5', '1234', 'Tester', 'Tester', 27, 'นาย', 'M', '1988-10-08', '0987676665', 'karoon@gmail.com', '66/5', 4, 70, 389, 60000, '101.99999', '999.10988', '2015-11-01 17:51:02', '1', '0000-00-00 00:00:00'),
(19, 'user10', '123456', 'นิธิพร', 'สุวรรณพรม', 20, 'นางสาว', 'F', '1995-08-27', '0851602671', 'tuta555@gmail.com', '569/1 บ้านท่าบ่อ ต.แจระแม อ.เมือง จ.อุบลราชธานี', 23, 312, 2796, 34320, '', '', '2015-11-07 13:15:16', '0', '0000-00-00 00:00:00'),
(20, 'user21', '123456', 'ฉัตรชัย', 'อินทวัด', 20, 'นาย', 'M', '6/02/1995', '0869848389', '', '38/4 ถนน อุบล-ตระกการ', 23, 312, 2788, 34000, '', '', '2015-11-07 13:20:34', '0', '0000-00-00 00:00:00'),
(21, 'user22', '123456', 'ณชพล', 'ทานให้', 22, 'นาย', 'M', '6/9/1993', '0838495392', '', '78/3 ถนน พโลชัย', 23, 312, 2788, 34200, '', '', '2015-11-07 13:24:11', '0', '0000-00-00 00:00:00'),
(22, 'user11', '123456', 'สายธาร ', 'วงค์หาญ', 19, 'นางสาว', 'F', '1996-03-03', '0942603435', 'dao111@gmail.com', '33 บ้านหัวเรือทอง ', 23, 312, 2791, 34000, '', '', '2015-11-07 13:26:26', '0', '0000-00-00 00:00:00'),
(23, 'user12', '123456', 'ศิริรัตน์ ', 'ทองสง่า', 19, 'นางสาว', 'F', '1995-12-22', '0900782328', 'fah_thongsanga9999@hotmail.com', '66/12 บ้านโพนทอง', 23, 315, 2835, 34320, '', '', '2015-11-07 13:29:23', '0', '0000-00-00 00:00:00'),
(24, 'user24', '123456', 'ธีระวิทย์', 'ศิริวาลย์', 22, 'นาย', 'M', '5/9/1993', '0986439564', '', '67/9 ถนน', 23, 315, 2825, 34320, '', '', '2015-11-07 13:32:30', '1', '0000-00-00 00:00:00'),
(25, 'user14', '123456', 'ไพรบูลย์ ', 'พาสง่า', 20, 'นางสาว', 'F', '1995-05-10', '087665423', 'pang@hotmail', '34 หมู่ 3', 23, 333, 3060, 34567, '', '', '2015-11-07 13:33:45', '1', '0000-00-00 00:00:00'),
(26, 'user15', '123456', 'สุภาภรณ์', 'บุญไพโรจน์', 20, 'นางสาว', 'F', '1995-09-15', '0834539806', 'nim11@hotmail.com', '55 หมู่ 5', 23, 318, 2864, 34568, '', '', '2015-11-07 13:36:44', '1', '0000-00-00 00:00:00'),
(27, 'user16', '123456', 'ธวินา', 'สลัดทุกข์', 20, 'นางสาว', 'F', '1995-10-04', '084569876', 'teng@gmail.com', '23 หมู่ 6', 23, 336, 3075, 35687, '', '', '2015-11-07 13:40:56', '1', '0000-00-00 00:00:00'),
(28, 'user27', '123456', 'สุรเชษฐ์', 'พงศ์โสภา', 23, 'นาย', 'M', '7/04/1992', '0879690395', '', '29/5', 23, 326, 2964, 34320, '', '', '2015-11-07 13:41:16', '1', '0000-00-00 00:00:00'),
(29, 'user31', '123456', 'ณัฐธิดา', 'บุญขจร', 19, 'นางสาว', 'F', '1996-01-06', '0863746281', 'beam06@hotmail.com', '60 ม.1 ', 23, 312, 2796, 34000, '', '', '2015-11-07 13:44:21', '1', '0000-00-00 00:00:00'),
(30, 'user18', '123456', 'อรอนงค์', 'เอ้โทบุตร', 19, 'นางสาว', 'F', '1996-05-21', '0872333290', 'ae@hotmail.com', '12 หมู่', 23, 333, 3058, 34567, '', '', '2015-11-07 13:44:36', '1', '0000-00-00 00:00:00'),
(31, 'user19', '123456', 'ลลิตา', 'ศรีภา', 19, 'นางสาว', 'F', '1995-11-17', '0865444323', 'jren@hotmail.com', '23 หมู่ 12', 23, 318, 2864, 34160, '', '', '2015-11-07 13:49:04', '1', '0000-00-00 00:00:00'),
(32, 'user32', '123456', 'อรนุช', 'สิงห์สู่', 19, 'นางสาว', 'F', '1996-10-30', '0984638265', 'pookkie_kie@hotmail.com', '291 ม.2', 23, 315, 2826, 34150, '', '', '2015-11-07 13:49:18', '1', '0000-00-00 00:00:00'),
(33, 'user29', '123456', 'สมรส', 'วันริโก', 43, 'นาย', 'M', '1972-11-07', '0985672347', 'somrut@gmail.com', '38/3', 23, 323, 2934, 34200, '', '', '2015-11-07 13:50:49', '1', '0000-00-00 00:00:00'),
(34, 'user20', '123456', 'สรรเสริญ', 'ทัดเทียม', 19, 'นาย', 'M', '1995-11-24', '0986754640', 'dep@hotmail.com', '4 หมู่ 2', 23, 312, 2800, 34000, '', '', '2015-11-07 13:52:21', '1', '0000-00-00 00:00:00'),
(35, 'user33', '123456', 'อิสราภรณ์', 'สิมมา', 19, 'นางสาว', 'F', '1996-07-15', '0927364532', 'pengnaruk@hotmail.com', '40 ม.1', 23, 312, 2788, 34000, '', '', '2015-11-07 13:52:30', '1', '0000-00-00 00:00:00'),
(36, 'user30', '123456', 'ภานุพงศ์', 'มุขดี', 54, 'นาย', 'M', '1960-11-26', '0646954633', 'panupong@gmail.com', '39/9', 23, 313, 2811, 34300, '', '', '2015-11-07 13:53:16', '1', '0000-00-00 00:00:00'),
(37, 'user34', '123456', 'สุภาพร', 'พรมทอง', 19, 'นางสาว', 'F', '1996-09-19', '0802763549', 'faheiei@hotmail.com', '45 ม.1', 23, 312, 2791, 34000, '', '', '2015-11-07 13:54:29', '1', '0000-00-00 00:00:00'),
(38, 'user35', '123456', 'พิมพิกา', 'อรการต์', 18, 'นางสาว', 'F', '1996-11-25', '0953974876', 'meaw1234@hotmail.com', '23 ม.2', 23, 330, 3024, 34110, '', '', '2015-11-07 13:56:54', '1', '0000-00-00 00:00:00'),
(39, 'user36', '123456', 'กนกอร', 'จิตเหลียว', 19, 'นางสาว', 'F', '1996-02-11', '0851608765', 'joommy@hotmail.com', '563 ม.1', 23, 316, 2843, 34170, '', '', '2015-11-07 13:58:47', '1', '0000-00-00 00:00:00'),
(40, 'user37', '123456', 'อรอนงค์', 'สิงห์ทอง', 18, 'นางสาว', 'F', '1996-12-22', '0948576857', 'nangnoi@hotmail.com', '70 ม.2', 23, 322, 2921, 34130, '', '', '2015-11-07 14:00:47', '1', '0000-00-00 00:00:00'),
(41, 'user38', '123456', 'นิภารัตน์', 'คำโพธิ์', 19, 'นางสาว', 'F', '1996-08-26', '0827365811', 'fernnykiki@hotmail.com', '122 ม.1', 23, 319, 2886, 34280, '', '', '2015-11-07 14:02:49', '1', '0000-00-00 00:00:00'),
(42, 'user39', '123456', 'ทัศนียา', 'สายใจ', 19, 'นางสาว', 'F', '1996-06-17', '0897673245', 'aing@hotmail.com', '223 ม.1', 23, 312, 2788, 34000, '', '', '2015-11-07 14:04:19', '1', '0000-00-00 00:00:00'),
(43, 'user40', '123456', 'แพรวพรรณ', 'ก้นทอง', 19, 'นางสาว', 'F', '1996-04-15', '0922287678', 'prawparw@hotmail.com', '44 ม.2', 23, 313, 2808, 34250, '', '', '2015-11-07 14:05:58', '1', '0000-00-00 00:00:00'),
(44, 'user13', '123456', 'ออมสิน', 'เพ็ญมาก', 18, 'นาย', 'M', '1996-11-16', '0984456789', 'ben123@hotmail.com', '89/2', 23, 326, 2967, 34567, '', '', '2015-11-07 14:43:35', '1', '0000-00-00 00:00:00'),
(45, 'user23', '123456', 'สุรเดช', 'คุณมี', 25, 'นาย', 'M', '1989-11-10', '08598835422', 'sudat@gmail.com', '26/6', 23, 313, 2810, 35090, '', '', '2015-11-07 14:46:47', '1', '0000-00-00 00:00:00'),
(46, 'user17', '123456', 'สุชาณี', 'สุขะภัณฑ์', 20, 'นางสาว', 'F', '1995-01-12', '0865668790', 'jen123@hotmail.com', '34/5', 23, 322, 2917, 35687, '', '', '2015-11-07 14:48:02', '1', '0000-00-00 00:00:00'),
(47, 'user25', '123456', 'อดิศักดิ์', 'บั้งทอง', 21, 'นาย', 'M', '1994-10-26', '0959861654', 'adisruk@gmail.com', '65/7', 23, 315, 2828, 34320, '', '', '2015-11-07 14:49:07', '1', '0000-00-00 00:00:00'),
(48, 'user26', '123456', 'เพรชรัตน์', 'เชื้อเพรช', 22, 'นาย', 'M', '1993-10-29', '09867345112', 'pasrut@gmail.com', '25/10', 23, 315, 2832, 34320, '', '', '2015-11-07 14:51:47', '1', '0000-00-00 00:00:00'),
(50, 'user28', '123456', 'สุพัฒน์', 'ขาวสะอาด', 28, 'นาย', 'M', '1986-11-21', '0976654432', '', '34/8', 23, 322, 2921, 34320, '', '', '2015-11-07 14:57:20', '1', '0000-00-00 00:00:00'),
(52, 'fah', '123456', 'ศิริรัตน์', 'ทองสง่า', 19, 'นางสาว', 'F', '1995-12-22', '0904587685', 'fah@gmail.com', '31/12', 3, 58, 301, 34320, '', '', '2015-11-11 15:11:54', '1', '2015-11-11 15:11:54'),
(53, 'fahnutty', '123456', 'ฟ้า', 'สวย', 20, 'นางสาว', 'F', '1995-08-10', '0215648547', 'fah@hotmail.com', '123', 23, 315, 2835, 34320, '', '', '2015-11-11 15:11:43', '1', '2015-11-11 15:11:43'),
(54, 'user41', '123456', 'พันชัย', 'ประสมเพรช', 26, 'นาย', 'M', '1988-12-21', '0875435550', 'thongtank@yhoo.com', '213/12', 23, 325, 2947, 34140, '', '', '2015-11-15 13:11:12', '1', '0000-00-00 00:00:00'),
(55, 'user17', '123456', 'สุชาณี', 'สุขะภัณฑ์', 20, 'นางสาว', 'F', '1995-09-22', '0982341245', 'jen123@hotmail.com', '60/1', 23, 322, 2914, 34010, '', '', '2015-11-17 10:29:00', '1', '0000-00-00 00:00:00');
...
INSERT INTO `rating` (`rating_id`, `hospital_id`, `profile_id`, `rate`, `date_added`) VALUES
(1, 6, 'user1', '5', '2015-11-06 12:18:49'),
(2, 10, 'user2', '4', '2015-11-06 12:22:45'),
(3, 10, 'user3', '5', '2015-11-06 15:25:02'),
(4, 8, 'user3', '4', '2015-11-07 12:52:07'),
(5, 8, 'user3', '4', '2015-11-07 12:53:10'),
(6, 1, 'user10', '5', '2015-11-07 14:17:08'),
(7, 1, 'user21', '4', '2015-11-07 14:18:58'),
(8, 2, 'user10', '4', '2015-11-07 14:21:16'),
(9, 12, 'user31', '4', '2015-11-07 14:23:33'),
(10, 11, 'user32', '5', '2015-11-07 14:26:50'),
(11, 2, 'user11', '5', '2015-11-07 14:28:23'),
(12, 3, 'user22', '4', '2015-11-07 14:28:28'),
(13, 10, 'user33', '5', '2015-11-07 14:30:17'),
(14, 9, 'user34', '5', '2015-11-07 14:34:05'),
(15, 8, 'user35', '5', '2015-11-07 14:37:08'),
(16, 6, 'user14', '5', '2015-11-07 14:37:54'),
(17, 7, 'user36', '5', '2015-11-07 14:39:02'),
(18, 6, 'user37', '5', '2015-11-07 14:40:42'),
(19, 5, 'user38', '5', '2015-11-07 14:42:02'),
(20, 4, 'user39', '5', '2015-11-07 14:43:36'),
(21, 3, 'user40', '5', '2015-11-07 14:45:26'),
(22, 4, 'user13', '5', '2015-11-07 14:53:40'),
(23, 1, 'user28', '5', '2015-11-07 15:02:11'),
(24, 10, 'user23', '3', '2015-11-07 15:04:01'),
(25, 6, 'user14', '5', '2015-11-07 15:06:58'),
(26, 11, 'user24', '4', '2015-11-07 15:07:17'),
(27, 3, 'user15', '5', '2015-11-07 15:08:37'),
(28, 6, 'user25', '4', '2015-11-07 15:09:05'),
(29, 5, 'user16', '5', '2015-11-07 15:10:46'),
(30, 12, 'user26', '4', '2015-11-07 15:10:49'),
(31, 6, 'user17', '5', '2015-11-07 15:12:41'),
(32, 3, 'user27', '3', '2015-11-07 15:12:48'),
(33, 4, 'user29', '5', '2015-11-07 15:14:26'),
(34, 8, 'user18', '5', '2015-11-07 15:14:35'),
(35, 4, 'user19', '5', '2015-11-07 15:16:51'),
(36, 6, 'user30', '5', '2015-11-07 15:17:16'),
(37, 3, 'user20', '5', '2015-11-07 15:19:42'),
(38, 6, 'user31', '5', '2015-11-07 15:30:51'),
(39, 12, 'user32', '5', '2015-11-07 15:34:10'),
(40, 4, 'user12', '5', '2015-11-07 15:34:16'),
(41, 8, 'user33', '5', '2015-11-07 15:36:47'),
(42, 5, 'user34', '5', '2015-11-07 15:38:25'),
(43, 7, 'user14', '5', '2015-11-07 15:39:01'),
(44, 6, 'user15', '5', '2015-11-07 15:41:15'),
(45, 5, 'user35', '5', '2015-11-07 15:41:42'),
(46, 1, 'user21', '5', '2015-11-07 15:42:15'),
(47, 6, 'user15', '5', '2015-11-07 15:42:42'),
(48, 1, 'user36', '5', '2015-11-07 15:43:10'),
(49, 2, 'user16', '5', '2015-11-07 15:43:54'),
(50, 8, 'user37', '5', '2015-11-07 15:45:16'),
(51, 3, 'user17', '5', '2015-11-07 15:45:50'),
(52, 6, 'user18', '5', '2015-11-07 15:47:28'),
(53, 6, 'user18', '5', '2015-11-07 15:49:04'),
(54, 3, 'user22', '5', '2015-11-07 16:08:41'),
(55, 1, 'user1', '5', '2015-11-10 13:43:07'),
(56, 10, 'user1', '5', '2015-11-10 22:59:09'),
(57, 1, 'user111', '5', '2015-11-11 12:44:53'),
(58, 3, 'fah', '5', '2015-11-11 15:06:05'),
(59, 1, 'fahnutty', '3', '2015-11-11 15:06:51'),
(60, 6, 'fahnutty', '5', '2015-11-11 15:07:58'),
(61, 5, 'fah', '3', '2015-11-11 15:08:06'),
(62, 2, 'fah', '5', '2015-11-11 15:12:46'),
(63, 4, 'fahnutty', '3', '2015-11-11 15:13:39'),
(64, 6, 'user10', '4', '2015-11-11 15:19:04'),
(65, 6, 'user21', '3', '2015-11-11 15:19:06'),
(66, 6, 'user11', '4', '2015-11-11 15:20:42'),
(67, 6, 'user22', '3', '2015-11-11 15:20:43'),
(68, 6, 'user23', '4', '2015-11-11 15:21:54'),
(69, 4, 'user12', '5', '2015-11-11 15:22:49'),
(70, 6, 'user24', '4', '2015-11-11 15:23:30'),
(71, 4, 'user13', '5', '2015-11-11 15:24:28'),
(72, 6, 'user25', '4', '2015-11-11 15:28:02'),
(73, 6, 'user14', '4', '2015-11-11 15:28:25'),
(74, 6, 'user15', '4', '2015-11-11 15:29:58'),
(75, 12, 'user26', '4', '2015-11-11 15:30:39'),
(76, 5, 'user16', '4', '2015-11-11 15:31:05'),
(77, 3, 'user27', '3', '2015-11-11 15:31:43'),
(78, 6, 'user18', '5', '2015-11-11 15:32:24'),
(79, 6, 'user28', '3', '2015-11-11 15:32:37'),
(80, 4, 'user19', '4', '2015-11-11 15:33:20'),
(81, 4, 'user29', '3', '2015-11-11 15:33:22'),
(82, 3, 'user20', '3', '2015-11-11 15:34:00'),
(83, 6, 'user30', '3', '2015-11-11 15:34:19'),
(84, 1, 'user40', '3', '2015-11-11 15:35:15'),
(85, 5, 'user31', '5', '2015-11-11 15:35:26'),
(86, 5, 'user39', '3', '2015-11-11 15:36:09'),
(87, 12, 'user33', '5', '2015-11-11 15:36:42'),
(88, 9, 'user38', '3', '2015-11-11 15:37:16'),
(89, 5, 'user34', '5', '2015-11-11 15:38:28'),
(90, 10, 'user37', '3', '2015-11-11 15:38:49'),
(91, 5, 'user35', '5', '2015-11-11 15:40:24'),
(92, 5, 'user36', '4', '2015-11-11 15:40:48'),
(93, 1, 'user10', '3', '2015-11-15 14:40:32'),
(94, 23, 'user10', '5', '2015-11-16 16:21:03'),
(95, 20, 'user10', '5', '2015-11-16 16:24:17'),
(96, 23, 'user10', '4', '2015-11-16 16:27:35'),
(97, 25, 'user11', '5', '2015-11-16 16:30:25'),
(98, 46, 'user11', '5', '2015-11-16 16:34:25'),
(99, 44, 'user31', '4', '2015-11-16 16:40:12'),
(100, 27, 'user13', '5', '2015-11-16 16:42:20'),
(101, 16, 'user32', '5', '2015-11-16 16:43:50'),
(102, 41, 'user13', '5', '2015-11-16 16:44:09'),
(103, 18, 'user33', '4', '2015-11-16 16:46:13'),
(104, 43, 'user14', '5', '2015-11-16 16:47:24'),
(105, 33, 'user34', '5', '2015-11-16 16:48:07'),
(106, 43, 'user14', '5', '2015-11-16 16:48:37'),
(107, 22, 'user35', '5', '2015-11-16 16:49:45'),
(108, 52, 'user15', '5', '2015-11-16 16:50:23'),
(109, 26, 'user36', '5', '2015-11-16 16:51:19'),
(110, 25, 'user15', '5', '2015-11-16 16:52:01'),
(111, 28, 'user37', '5', '2015-11-16 16:54:14'),
(112, 13, 'user16', '5', '2015-11-16 16:54:22'),
(113, 25, 'user16', '5', '2015-11-16 16:56:04'),
(114, 30, 'user38', '4', '2015-11-16 16:56:39'),
(115, 48, 'user16', '5', '2015-11-16 16:57:56'),
(116, 37, 'user39', '5', '2015-11-16 16:58:29'),
(117, 52, 'user17', '5', '2015-11-16 17:00:40'),
(118, 50, 'user40', '5', '2015-11-16 17:01:33'),
(119, 53, 'user17', '5', '2015-11-16 17:02:55'),
(120, 27, 'user17', '5', '2015-11-16 17:04:16'),
(121, 17, 'user21', '5', '2015-11-16 17:05:14'),
(122, 32, 'user17', '5', '2015-11-16 17:05:49'),
(123, 36, 'user18', '5', '2015-11-16 17:07:25'),
(124, 29, 'user18', '5', '2015-11-16 17:11:03'),
(125, 59, 'user22', '5', '2015-11-16 17:11:47'),
(126, 41, 'user18', '5', '2015-11-16 17:12:24'),
(127, 40, 'user19', '5', '2015-11-16 17:13:42'),
(128, 58, 'user23', '5', '2015-11-16 17:14:00'),
(129, 20, 'user19', '5', '2015-11-16 17:14:46'),
(130, 57, 'user24', '5', '2015-11-16 17:14:57'),
(131, 35, 'user19', '5', '2015-11-16 17:15:45'),
(132, 55, 'user25', '5', '2015-11-16 17:17:17'),
(133, 35, 'user19', '5', '2015-11-16 17:17:47'),
(134, 56, 'user20', '5', '2015-11-16 17:19:20'),
(135, 41, 'user20', '5', '2015-11-16 17:20:31'),
(136, 49, 'user26', '5', '2015-11-16 17:21:04'),
(137, 48, 'user20', '5', '2015-11-16 17:22:16'),
(138, 47, 'user27', '5', '2015-11-16 17:22:25'),
(139, 40, 'user28', '5', '2015-11-16 17:24:29'),
(140, 45, 'user29', '5', '2015-11-16 17:25:59'),
(141, 24, 'user30', '5', '2015-11-16 17:27:32'),
(142, 46, 'user17', '5', '2015-11-17 13:05:33');

-- --------------------------------------------------------

--
-- Table structure for table `special_medical`
--

CREATE TABLE `special_medical` (
  `special_id` int(11) NOT NULL,
  `medical_type_id` int(3) NOT NULL,
  `hospital_id` int(11) NOT NULL,
...
--
-- Dumping data for table `special_medical`
--

INSERT INTO `special_medical` (`special_id`, `medical_type_id`, `hospital_id`, `min_price`, `max_price`, `date_added`) VALUES
(16, 1, 1, 1, 1, '2015-10-28 16:55:13'),
(17, 2, 1, 3, 3, '2015-10-28 16:55:13'),
(18, 3, 1, 1000, 1500, '2015-11-04 12:31:39'),
(19, 1, 1, 15000, 50000, '2015-11-04 12:31:39'),
(20, 4, 1, 2000, 5000, '2015-11-04 12:31:39'),
(21, 34, 2, 1000, 4000, '2015-11-04 12:33:39'),
(22, 16, 2, 30, 500, '2015-11-04 12:33:39'),
(23, 20, 3, 3000, 4000, '2015-11-04 12:34:35'),
(24, 16, 3, 30, 500, '2015-11-04 12:34:35'),
(25, 19, 4, 1500, 2000, '2015-11-04 12:36:17'),
(26, 23, 4, 5000, 10000, '2015-11-04 12:36:17'),
(27, 22, 5, 1000, 20000, '2015-11-04 12:38:37'),
(28, 29, 5, 2000, 25000, '2015-11-04 12:38:37'),
(29, 20, 6, 2000, 5000, '2015-11-04 12:41:14'),
(30, 6, 6, 10000, 35000, '2015-11-04 12:41:14'),
(31, 18, 6, 15000, 50000, '2015-11-04 12:41:14'),
(32, 25, 6, 3000, 5000, '2015-11-04 12:41:14'),
(33, 22, 8, 5000, 10000, '2015-11-04 12:49:12'),
(34, 26, 8, 4000, 8000, '2015-11-04 12:49:12'),
(35, 23, 9, 500, 1000, '2015-11-04 12:50:08'),
(36, 24, 9, 100, 200, '2015-11-04 12:50:08'),
(37, 7, 10, 2000, 5000, '2015-11-04 12:51:59'),
(38, 22, 10, 200, 500, '2015-11-04 12:52:00'),
(39, 3, 10, 200, 500, '2015-11-04 12:52:00'),
(40, 3, 11, 300, 500, '2015-11-04 12:53:39'),
(41, 28, 11, 1000, 1500, '2015-11-04 12:53:39'),
(42, 27, 12, 3000, 4000, '2015-11-04 12:55:07'),
(43, 32, 12, 1200, 2000, '2015-11-04 12:55:07'),
(44, 29, 12, 3000, 5000, '2015-11-04 12:55:07'),
(45, 3, 1, 500, 600, '2015-11-04 12:55:50'),
(46, 4, 1, 200, 295, '2015-11-04 12:55:50'),
(47, 31, 5, 12000, 30000, '2015-11-04 12:57:07'),
(48, 21, 5, 5000, 13000, '2015-11-04 12:57:07'),
(49, 30, 5, 4000, 10000, '2015-11-04 12:57:07'),
(50, 22, 8, 20000, 30000, '2015-11-04 12:57:58'),
(51, 33, 8, 12000, 20000, '2015-11-04 12:57:58'),
(52, 24, 6, 3000, 5000, '2015-11-04 13:01:18'),
(53, 32, 6, 1000, 1500, '2015-11-04 13:01:18'),
(54, 7, 6, 2000, 5000, '2015-11-04 13:01:18'),
(55, 30, 11, NULL, NULL, '2015-11-07 13:29:58'),
(56, 26, 11, NULL, NULL, '2015-11-07 13:29:58'),
(57, 4, 16, NULL, NULL, '2015-11-16 17:00:29'),
(58, 6, 16, NULL, NULL, '2015-11-16 17:00:29'),
(59, 22, 16, NULL, NULL, '2015-11-16 17:00:29'),
(60, 27, 16, NULL, NULL, '2015-11-16 17:00:29'),
(61, 23, 16, NULL, NULL, '2015-11-16 17:00:29'),
(62, 17, 13, NULL, NULL, '2015-11-16 17:00:57'),
(63, 16, 13, NULL, NULL, '2015-11-16 17:00:57'),
(64, 4, 13, NULL, NULL, '2015-11-16 17:00:57'),
(65, 23, 13, NULL, NULL, '2015-11-16 17:00:57'),
(66, 28, 13, NULL, NULL, '2015-11-16 17:00:57'),
(67, 7, 19, NULL, NULL, '2015-11-16 17:04:06'),
(68, 4, 19, NULL, NULL, '2015-11-16 17:04:06'),
(69, 6, 19, NULL, NULL, '2015-11-16 17:04:06'),
(70, 16, 19, NULL, NULL, '2015-11-16 17:04:06'),
(71, 19, 19, NULL, NULL, '2015-11-16 17:04:06'),
(72, 19, 14, NULL, NULL, '2015-11-16 17:04:24'),
(73, 16, 14, NULL, NULL, '2015-11-16 17:04:24'),
(74, 7, 14, NULL, NULL, '2015-11-16 17:04:24'),
(75, 18, 14, NULL, NULL, '2015-11-16 17:04:24'),
(76, 17, 13, NULL, NULL, '2015-11-16 17:06:41'),
(77, 18, 13, NULL, NULL, '2015-11-16 17:06:41'),
(78, 20, 13, NULL, NULL, '2015-11-16 17:06:41'),
(79, 23, 13, NULL, NULL, '2015-11-16 17:06:41'),
(80, 26, 13, NULL, NULL, '2015-11-16 17:06:41'),
(81, 22, 18, NULL, NULL, '2015-11-16 17:07:03'),
(82, 17, 18, NULL, NULL, '2015-11-16 17:07:03'),
(83, 3, 18, NULL, NULL, '2015-11-16 17:07:03'),
(84, 1, 18, NULL, NULL, '2015-11-16 17:07:03'),
(85, 34, 27, NULL, NULL, '2015-11-16 17:07:28'),
(86, 35, 27, NULL, NULL, '2015-11-16 17:07:28'),
(87, 36, 27, NULL, NULL, '2015-11-16 17:07:28'),
(88, 37, 27, NULL, NULL, '2015-11-16 17:07:28'),
(89, 25, 27, NULL, NULL, '2015-11-16 17:07:28'),
(90, 17, 23, NULL, NULL, '2015-11-16 17:07:46'),
(91, 4, 23, NULL, NULL, '2015-11-16 17:07:46'),
(92, 7, 23, NULL, NULL, '2015-11-16 17:07:46'),
(93, 16, 23, NULL, NULL, '2015-11-16 17:07:46'),
(94, 22, 47, NULL, NULL, '2015-11-16 17:08:12'),
(95, 17, 47, NULL, NULL, '2015-11-16 17:08:12'),
(96, 37, 47, NULL, NULL, '2015-11-16 17:08:12'),
(97, 33, 47, NULL, NULL, '2015-11-16 17:08:12'),
(98, 29, 47, NULL, NULL, '2015-11-16 17:08:12'),
(99, 26, 59, NULL, NULL, '2015-11-16 17:08:38'),
(100, 21, 59, NULL, NULL, '2015-11-16 17:08:38'),
(101, 23, 59, NULL, NULL, '2015-11-16 17:08:38'),
(102, 25, 59, NULL, NULL, '2015-11-16 17:08:38'),
(103, 35, 59, NULL, NULL, '2015-11-16 17:08:38'),
(104, 20, 58, NULL, NULL, '2015-11-16 17:09:01'),
(105, 28, 58, NULL, NULL, '2015-11-16 17:09:01'),
(106, 24, 58, NULL, NULL, '2015-11-16 17:09:01'),
(107, 7, 58, NULL, NULL, '2015-11-16 17:09:01'),
(108, 35, 58, NULL, NULL, '2015-11-16 17:09:01'),
(109, 19, 52, NULL, NULL, '2015-11-16 17:09:26'),
(110, 22, 52, NULL, NULL, '2015-11-16 17:09:26'),
(111, 26, 52, NULL, NULL, '2015-11-16 17:09:26'),
(112, 32, 52, NULL, NULL, '2015-11-16 17:09:26'),
(113, 35, 52, NULL, NULL, '2015-11-16 17:09:26'),
(114, 37, 56, NULL, NULL, '2015-11-16 17:10:47'),
(115, 36, 56, NULL, NULL, '2015-11-16 17:10:47'),
(116, 35, 56, NULL, NULL, '2015-11-16 17:10:47'),
(117, 34, 56, NULL, NULL, '2015-11-16 17:10:47'),
(118, 32, 56, NULL, NULL, '2015-11-16 17:10:47'),
(119, 18, 54, NULL, NULL, '2015-11-16 17:11:08'),
(120, 21, 54, NULL, NULL, '2015-11-16 17:11:08'),
(121, 20, 54, NULL, NULL, '2015-11-16 17:11:08'),
(122, 23, 54, NULL, NULL, '2015-11-16 17:11:08'),
(123, 24, 57, NULL, NULL, '2015-11-16 17:11:41'),
(124, 29, 57, NULL, NULL, '2015-11-16 17:11:41'),
(125, 35, 57, NULL, NULL, '2015-11-16 17:11:41'),
(126, 18, 57, NULL, NULL, '2015-11-16 17:11:41'),
(127, 16, 57, NULL, NULL, '2015-11-16 17:11:41'),
(128, 17, 46, NULL, NULL, '2015-11-16 17:22:27'),
(129, 4, 46, NULL, NULL, '2015-11-16 17:22:27'),
(130, 7, 46, NULL, NULL, '2015-11-16 17:22:27'),
(131, 25, 46, NULL, NULL, '2015-11-16 17:22:27'),
(132, 27, 46, NULL, NULL, '2015-11-16 17:22:27'),
(133, 16, 36, NULL, NULL, '2015-11-16 17:27:03'),
(134, 7, 36, NULL, NULL, '2015-11-16 17:27:03'),
(135, 22, 36, NULL, NULL, '2015-11-16 17:27:03'),
(136, 24, 36, NULL, NULL, '2015-11-16 17:27:03'),
(137, 29, 36, NULL, NULL, '2015-11-16 17:27:03');

-- --------------------------------------------------------

--
-- Table structure for table `typeofmedical`
--

CREATE TABLE `typeofmedical` (
  `medical_type_id` int(3) NOT NULL,
...
--
-- Dumping data for table `typeofmedical`
--

INSERT INTO `typeofmedical` (`medical_type_id`, `medical_name`, `date_added`, `added_from`) VALUES
(1, 'ศัลยกรรม', '2015-10-28 14:25:33', 'admin'),
(3, 'อายุรกรรม', '2015-10-28 14:28:11', 'admin'),
(4, 'เวชกรรม', '2015-10-30 23:19:33', 'admin'),
(6, 'ผ่าตัด', '2015-10-31 15:53:45', 'admin'),
(7, 'กุมารแพทย์', '2015-10-31 15:54:14', 'admin'),
(16, 'ทันตแพทย์', '2015-11-03 15:19:49', 'admin'),
(17, 'ศัลยแพทย์ทั่วไป', '2015-11-03 15:20:12', 'admin'),
(18, 'ศัลยกรรมตกแต่ง', '2015-11-03 15:20:34', 'admin'),
(19, 'เภสัช', '2015-11-03 15:46:35', 'admin'),
(20, 'รังสีแพทย์', '2015-11-03 15:21:11', 'admin'),
(21, 'เวชศาสตร์ฟื้นฟู', '2015-11-03 15:34:47', 'admin'),
(22, 'จิตเวชศาสตร์', '2015-11-03 15:35:07', 'admin'),
(23, 'นิติเวชศาสตร์', '2015-11-03 15:35:22', 'admin'),
(24, 'พยาธิวิทยาทั่วไป', '2015-11-03 15:35:41', 'admin'),
(25, 'รังสีวิทยาทั่วไป', '2015-11-03 15:35:57', 'admin'),
(26, 'วิสัญญีวิทยา', '2015-11-03 15:36:11', 'admin'),
(27, 'เวชปฏิบัติทั่วไป', '2015-11-03 15:36:30', 'admin'),
(28, 'เวชศาสตร์ครอบครัว', '2015-11-03 15:36:44', 'admin'),
(29, 'อายุรศาสตร์', '2015-11-03 15:37:00', 'admin'),
(30, 'โสต ศอ นาสิกวิทยา', '2015-11-03 15:37:28', 'admin'),
(31, 'สูติศาสตร์-นรีเวชวิทยา', '2015-11-03 15:37:45', 'admin'),
(32, 'แพทย์ทางเลือก', '2015-11-03 15:38:42', 'admin'),
(33, 'แพทย์เฉพาะทาง', '2015-11-03 15:38:59', 'admin'),
(34, 'กายภาพบำบัด', '2015-11-03 15:39:21', 'admin'),
(35, 'ICU', '2015-11-15 15:07:09', 'admin'),
(36, 'ผู้ป่วยฉุกเฉิน', '2015-11-16 16:29:04', 'admin'),
(37, 'ผู้ป่วยโรคทั่วไป', '2015-11-16 16:29:30', 'admin');
...
ALTER TABLE `medicine_order`
  ADD PRIMARY KEY (`medicine_order_id`,`medicine_id`,`medical_id`);
...
--
ALTER TABLE `rating`
  ADD PRIMARY KEY (`rating_id`,`hospital_id`,`profile_id`);

--
-- Indexes for table `special_medical`
--
ALTER TABLE `special_medical`
  ADD PRIMARY KEY (`special_id`,`medical_type_id`,`hospital_id`);

--
-- Indexes for table `typeofmedical`
--
ALTER TABLE `typeofmedical`
  ADD PRIMARY KEY (`medical_type_id`);
...
--
ALTER TABLE `medical`
  MODIFY `medical_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=142;
--
-- AUTO_INCREMENT for table `medicine_order`
--
ALTER TABLE `medicine_order`
  MODIFY `medicine_order_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=207;
--
-- AUTO_INCREMENT for table `profile`
--
ALTER TABLE `profile`
  MODIFY `profile_id` int(10) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
...
--
ALTER TABLE `rating`
  MODIFY `rating_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=143;
--
-- AUTO_INCREMENT for table `special_medical`
--
ALTER TABLE `special_medical`
  MODIFY `special_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=138;
--
-- AUTO_INCREMENT for table `typeofmedical`
--
ALTER TABLE `typeofmedical`
  MODIFY `medical_type_id` int(3) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=38;
